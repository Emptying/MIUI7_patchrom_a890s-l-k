...
.field private static final IME_FEEDBACK_SOUND:[I

.field private static final INDEX_OF_KEYBOARD_FEEDBACK_SOUND:Ljava/lang/String; = "index_of_keyboard_feedback_sound"

.field private static final INDEX_OF_TOUCH_FEEDBACK_SOUND:Ljava/lang/String; = "index_of_touch_feedback_sound"
...
.field private static final TOUCH_FEEDBACK_SOUND:[I
...
.field private mImeFeedbackEffect:I
...
.field private mTouchFeedbackEffect:I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/media/AudioService;->TOUCH_FEEDBACK_SOUND:[I
    ...
    sput-object v0, Landroid/media/AudioService;->IME_FEEDBACK_SOUND:[I
...
.method static synthetic access$5100(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 125
    iget v0, p0, Landroid/media/AudioService;->mTouchFeedbackEffect:I
...
.method static synthetic access$5102(Landroid/media/AudioService;I)I
    ...
    .prologue
    .line 125
    iput p1, p0, Landroid/media/AudioService;->mTouchFeedbackEffect:I
...
.method static synthetic access$5200(Landroid/media/AudioService;)I
    ...
    .prologue
    .line 125
    iget v0, p0, Landroid/media/AudioService;->mImeFeedbackEffect:I

    return v0
.end method

.method static synthetic access$5202(Landroid/media/AudioService;I)I
    .locals 0
    .param p0, "x0"    # Landroid/media/AudioService;
    .param p1, "x1"    # I
    ...
    .prologue
    .line 125
    iput p1, p0, Landroid/media/AudioService;->mImeFeedbackEffect:I
...
.method static synthetic access$7700()[I
    ...
    .prologue
    .line 125
    sget-object v0, Landroid/media/AudioService;->TOUCH_FEEDBACK_SOUND:[I
...
.method static synthetic access$7800()[I
    ...
    .prologue
    .line 125
    sget-object v0, Landroid/media/AudioService;->IME_FEEDBACK_SOUND:[I
...
.method private readPersistedSettings()V
    ...
    .line 743
    :cond_2
    iget-boolean v9, p0, Landroid/media/AudioService;->mUseFixedVolume:Z
    ...
    invoke-static {v0, v8, v9, v13}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-static {v0, v8, v7, v13}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 791
    iget-object v6, p0, Landroid/media/AudioService;->mMediaFocusControl:Landroid/media/MediaFocusControl;

    invoke-virtual {v6}, Landroid/media/MediaFocusControl;->restoreMediaButtonReceiver()V

    .line 795
    iget-object v6, p0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v8, "index_of_touch_feedback_sound"

    invoke-static {v6, v8, v7, v13}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I

    move-result v5

    .line 796
    .local v5, "touchEffect":I
    iget-object v6, p0, Landroid/media/AudioService;->mContentResolver:Landroid/content/ContentResolver;

    const-string v8, "index_of_keyboard_feedback_sound"
    ...
    .line 797
    .local v1, "imeEffect":I
    if-ltz v5, :cond_5

    sget-object v6, Landroid/media/AudioService;->TOUCH_FEEDBACK_SOUND:[I
    ...
    const-string v8, "invalid touchEffect index : "
    ...
    sget-object v6, Landroid/media/AudioService;->IME_FEEDBACK_SOUND:[I
    ...
    const-string v8, "invalid imeEffect index : "
    ...
    iput v6, p0, Landroid/media/AudioService;->mTouchFeedbackEffect:I
    ...
    iput v6, p0, Landroid/media/AudioService;->mImeFeedbackEffect:I

    .line 809
    return-void

    .end local v1    # "imeEffect":I
    .end local v2    # "masterMute":Z
    .end local v5    # "touchEffect":I
    :cond_9
    move v9, v7
...
.method private sendVolumeUpdate(IIII)V
    ...
    :cond_0
    iget-boolean v1, p0, Landroid/media/AudioService;->mExtremeVolume:Z
...
.method private setRingerModeInt(IZ)V
    ...
    .line 1532
    :cond_6
    const-string/jumbo v1, "persist.sys.pantechvolume"
...
.method public adjustStreamVolume(IIILjava/lang/String;)V
    ...
    .prologue
    .line 892
    const-string/jumbo v10, "sys.shutdown.requested"

    .line 893
    .local v10, "SHUTDOWN_ACTION_PROPERTY":Ljava/lang/String;
    const-string v3, ""
    ...
    .line 895
    .local v16, "shutdownAction":Ljava/lang/String;
    if-eqz v16, :cond_1
    ...
    const-string v5, "), shutdownAction="
    ...
    invoke-direct {v0, v12, v1, v2}, Landroid/media/AudioService;->checkForRingerModeChange(III)Z
...
.method public setExtremeVolume(Z)V
    ...
    .prologue
    .line 4827
    iput-boolean p1, p0, Landroid/media/AudioService;->mExtremeVolume:Z
...
.method public setWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string v2, "setWiredDeviceConnectionState()  mBootCompleted = "
    ...
    const-string v2, ", bHSPlugedAtBootTime = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-boolean v2, Landroid/media/AudioManager;->bHSPlugedAtBootTime:Z
    ...
    const-string v0, "android.media.AUDIO_HEADSET_PLUGED"

    invoke-direct {v7, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v7, "intent":Landroid/content/Intent;
    sget-boolean v0, Landroid/media/AudioManager;->bHSPlugedAtBootTime:Z

    if-eqz v0, :cond_2

    const-string v0, "hs_pluged_boottime"
    ...
    const-string v0, "android.media.AUDIO_HEADSET_UNPLUGED"
