...
.method private declared-synchronized SKYSounds_getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    .locals 11
    ...
    const-string/jumbo v2, "name LIKE \'"
    ...
    const-string v0, "content://skysounds_set/skysounds"
    ...
    .line 1187
    :cond_2
    const-string v0, "SKYSounds_getString"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "strValue = "
...
.method static synthetic access$3100(Landroid/media/MediaScanner$MyMediaScannerClient;Landroid/net/Uri;JLjava/lang/String;)V
    .locals 0
    ...
    .prologue
    .line 467
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/media/MediaScanner$MyMediaScannerClient;->setVideoCallRingtone(Landroid/net/Uri;JLjava/lang/String;)V

    return-void
.end method

.method static synthetic access$3200(Landroid/media/MediaScanner$MyMediaScannerClient;Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Landroid/media/MediaScanner$MyMediaScannerClient;
    ...
    .prologue
    .line 467
    invoke-direct {p0, p1, p2}, Landroid/media/MediaScanner$MyMediaScannerClient;->SKYSounds_getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
...
.method private setSettingIfNotSet(Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    # getter for: Landroid/media/MediaScanner;->mDefaultRingtoneSet:Z
    invoke-static {v1}, Landroid/media/MediaScanner;->access$2000(Landroid/media/MediaScanner;)Z
    ...
    .line 1207
    const-string/jumbo v1, "ringtone_video_uri"

    invoke-direct {p0, p2, p3, p4, v1}, Landroid/media/MediaScanner$MyMediaScannerClient;->setVideoCallRingtone(Landroid/net/Uri;JLjava/lang/String;)V
...
.method private setVideoCallRingtone(Landroid/net/Uri;JLjava/lang/String;)V
    .locals 10
    ...
    .prologue
    .line 1116
    const-string/jumbo v7, "setSettingIfNotSet"
    ...
    .line 1144
    .local v6, "putString":Ljava/lang/reflect/Method;
    const/4 v7, 0x3
    ...
    # getter for: Landroid/media/MediaScanner;->mContext:Landroid/content/Context;
    invoke-static {v8}, Landroid/media/MediaScanner;->access$2600(Landroid/media/MediaScanner;)Landroid/content/Context;
    ...
    .line 1145
    .local v4, "paramEnable":[Ljava/lang/Object;
    const/4 v7, 0x0
    ...
    .line 1153
    .end local v4    # "paramEnable":[Ljava/lang/Object;
    .end local v5    # "parameterTypes":[Ljava/lang/Class;
    .end local v6    # "putString":Ljava/lang/reflect/Method;
    :cond_0
    :goto_1
    return-void
    ...
    invoke-static {v7, v8, v3}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private toValues()Landroid/content/ContentValues;
    ...
    iget v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDiscNum:I
    ...
    iget-object v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSongID:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mCopyRight:Ljava/lang/String;
...
.method public beginFile(Ljava/lang/String;Ljava/lang/String;JJZZ)Landroid/media/MediaScanner$FileEntry;
    ...
    iput v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDiscNum:I

    .line 571
    const/4 v3, 0x0

    iput-object v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSongID:Ljava/lang/String;

    .line 572
    const/4 v3, 0x0

    iput-object v3, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mCopyRight:Ljava/lang/String;
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZZZ)Landroid/net/Uri;
    ...
    const-string v10, "doScanFile() path includes hidden folder started with \'.\'"
...
.method public handleStringTag(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDiscNum:I
    ...
    iput v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mDiscNum:I
    ...
    iput-object v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mSongID:Ljava/lang/String;
    ...
    iput-object v1, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mCopyRight:Ljava/lang/String;
