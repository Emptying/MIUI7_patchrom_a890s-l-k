...
.method constructor <init>(IIZZLandroid/bluetooth/BluetoothDevice;ILandroid/os/ParcelUuid;)V
    ...
    const-string v3, "Invalid RFCOMM channel: "
    ...
    const-string v2, "Bluetooth Device Policy violation"
    ...
    invoke-direct {v2, v5, v6, v5, v6}, Ljava/util/UUID;-><init>(JJ)V

    invoke-direct {v1, v2}, Landroid/os/ParcelUuid;-><init>(Ljava/util/UUID;)V

    iput-object v1, p0, Landroid/bluetooth/BluetoothSocket;->mUuid:Landroid/os/ParcelUuid;
...
.method read([BII)I
    ...
    const-string v4, "Bluetooth Device Policy violation"
    ...
    const-string v5, "bt socket closed, read return: "
    ...
    const-string v4, "IOException while reading the InputStream"
