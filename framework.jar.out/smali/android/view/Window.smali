...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/view/Window$MultiWindowStateChangeCallback;,
        Landroid/view/Window$Callback;,
        Landroid/view/Window$RearCallback;
    }
.end annotation
...
.field private mDisableDoubleTab:Z

.field private mDisableRearTouch:Z

.field private mEnableFingerKey:Z
...
.field private mRearCallback:Landroid/view/Window$RearCallback;
...
.method public addPantechFlags(I)V
    .locals 0
    .param p1, "flags"    # I

    .prologue
    .line 764
    invoke-virtual {p0, p1, p1}, Landroid/view/Window;->setPantechFlags(II)V
...
.method public clearPantechFlags(I)V
    .locals 1
    .param p1, "flags"    # I
    ...
    invoke-virtual {p0, v0, p1}, Landroid/view/Window;->setPantechFlags(II)V
...
.method public getMultiWindowStateChangeCallback()Landroid/view/Window$MultiWindowStateChangeCallback;
    .locals 1

    .prologue
    .line 1432
    iget-object v0, p0, Landroid/view/Window;->mWindowStateChangeCallback:Landroid/view/Window$MultiWindowStateChangeCallback;

    return-object v0
.end method

.method public getRearCallback()Landroid/view/Window$RearCallback;
    .locals 1

    .prologue
    .line 192
    iget-object v0, p0, Landroid/view/Window;->mRearCallback:Landroid/view/Window$RearCallback;

    return-object v0
.end method

.method public getVegaPhoneWindowWrapper()Ljava/lang/Object;
    .locals 1
...
.method public isDoubleTabDisable()Z
    ...
    .prologue
    .line 200
    iget-boolean v0, p0, Landroid/view/Window;->mDisableDoubleTab:Z
...
.method public isFingerKeyEnable()Z
    ...
    .prologue
    .line 208
    iget-boolean v0, p0, Landroid/view/Window;->mEnableFingerKey:Z
...
.method public isRearTouchDisable()Z
    ...
    .prologue
    .line 216
    iget-boolean v0, p0, Landroid/view/Window;->mDisableRearTouch:Z
...
.method public setAttributes(Landroid/view/WindowManager$LayoutParams;Z)V
    ...
    .line 889
    invoke-virtual {p0, p1}, Landroid/view/Window;->onWindowVegaAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
...
.method public setDoubleTabDisable(Z)V
    .locals 0
    .param p1, "flag"    # Z

    .prologue
    .line 196
    iput-boolean p1, p0, Landroid/view/Window;->mDisableDoubleTab:Z
...
.method public setFingerKeyEnable(Z)V
    .locals 0
    .param p1, "flag"    # Z

    .prologue
    .line 204
    iput-boolean p1, p0, Landroid/view/Window;->mEnableFingerKey:Z
...
.method public setFlags(II)V
    ...
    invoke-virtual {p0, v0}, Landroid/view/Window;->onWindowVegaAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
...
.method public setMultiWindowStateChangeCallback(Landroid/view/Window$MultiWindowStateChangeCallback;)V
    ...
    .prologue
    .line 1428
    iput-object p1, p0, Landroid/view/Window;->mWindowStateChangeCallback:Landroid/view/Window$MultiWindowStateChangeCallback;

    .line 1429
    return-void
.end method

.method public setPantechFlags(II)V
    .locals 3
    .param p1, "flags"    # I
    .param p2, "mask"    # I
    ...
    .line 773
    .local v0, "attrs":Landroid/view/WindowManager$LayoutParams;
    iget v1, v0, Landroid/view/WindowManager$LayoutParams;->pantechFlags:I
    ...
    iput v1, v0, Landroid/view/WindowManager$LayoutParams;->pantechFlags:I
...
.method public setRearCallback(Landroid/view/Window$RearCallback;)V
    .locals 0
    .param p1, "callback"    # Landroid/view/Window$RearCallback;

    .prologue
    .line 188
    iput-object p1, p0, Landroid/view/Window;->mRearCallback:Landroid/view/Window$RearCallback;

    .line 189
    return-void
.end method

.method public setRearTouchDisable(Z)V
    .locals 0
    .param p1, "flag"    # Z

    .prologue
    .line 212
    iput-boolean p1, p0, Landroid/view/Window;->mDisableRearTouch:Z
