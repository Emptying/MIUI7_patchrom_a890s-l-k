...
.method public notifyRearTouchStatus(ZI)V
    ...
    .prologue
    .line 6880
    sput-boolean p1, Landroid/view/ViewRootImpl;->mRearTouchEnabled:Z

    .line 6881
    sput p2, Landroid/view/ViewRootImpl;->mRearTouchMode:I
    ...
    .line 6884
    invoke-virtual {v0, p1, p2}, Landroid/view/ViewRootImpl;->notifyRearTouchStatus(ZI)V
...
.method public processVoiceAction(Landroid/os/Bundle;)V
    .locals 3
    .param p1, "name"    # Landroid/os/Bundle;
    ...
    .line 6896
    const-string/jumbo v2, "voice_action"
    ...
    .line 6898
    .local v1, "widgetName":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    # invokes: Landroid/view/ViewRootImpl;->processVoiceAction(Ljava/util/ArrayList;)V
    invoke-static {v0, v1}, Landroid/view/ViewRootImpl;->access$2700(Landroid/view/ViewRootImpl;Ljava/util/ArrayList;)V

    .line 6900
    .end local v1    # "widgetName":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_0
    return-void
.end method
