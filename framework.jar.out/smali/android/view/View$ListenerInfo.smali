...
.field private mOnDrawVoiceActionListener:Landroid/view/View$OnDrawVoiceActionListener;
...
.field private mOnVoiceListListener:Landroid/view/View$OnVoiceListListener;
...
.method static synthetic access$1300(Landroid/view/View$ListenerInfo;)Landroid/view/View$OnSystemUiVisibilityChangeListener;
    .locals 1
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;
...
.method static synthetic access$1302(Landroid/view/View$ListenerInfo;Landroid/view/View$OnSystemUiVisibilityChangeListener;)Landroid/view/View$OnSystemUiVisibilityChangeListener;
    .locals 0
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;
...
.method static synthetic access$600(Landroid/view/View$ListenerInfo;)Landroid/view/View$OnVoiceListListener;
    .locals 1
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;

    .prologue
    .line 3150
    iget-object v0, p0, Landroid/view/View$ListenerInfo;->mOnVoiceListListener:Landroid/view/View$OnVoiceListListener;

    return-object v0
.end method

.method static synthetic access$602(Landroid/view/View$ListenerInfo;Landroid/view/View$OnVoiceListListener;)Landroid/view/View$OnVoiceListListener;
    .locals 0
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;
    .param p1, "x1"    # Landroid/view/View$OnVoiceListListener;

    .prologue
    .line 3150
    iput-object p1, p0, Landroid/view/View$ListenerInfo;->mOnVoiceListListener:Landroid/view/View$OnVoiceListListener;

    return-object p1
.end method

.method static synthetic access$700(Landroid/view/View$ListenerInfo;)Landroid/view/View$OnDrawVoiceActionListener;
    .locals 1
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;

    .prologue
    .line 3150
    iget-object v0, p0, Landroid/view/View$ListenerInfo;->mOnDrawVoiceActionListener:Landroid/view/View$OnDrawVoiceActionListener;

    return-object v0
.end method

.method static synthetic access$702(Landroid/view/View$ListenerInfo;Landroid/view/View$OnDrawVoiceActionListener;)Landroid/view/View$OnDrawVoiceActionListener;
    .locals 0
    .param p0, "x0"    # Landroid/view/View$ListenerInfo;
    .param p1, "x1"    # Landroid/view/View$OnDrawVoiceActionListener;

    .prologue
    .line 3150
    iput-object p1, p0, Landroid/view/View$ListenerInfo;->mOnDrawVoiceActionListener:Landroid/view/View$OnDrawVoiceActionListener;
