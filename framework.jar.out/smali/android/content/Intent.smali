...
.field public static final ACTION_BACK_COVER_CAMERA_BMP_STATE:Ljava/lang/String; = "com.pantech.intent.action.BACK_COVER_CAMERA_BMP_STATE"

.field public static final ACTION_BACK_COVER_PIEZO_SPK_STATE:Ljava/lang/String; = "com.pantech.intent.action.BACK_COVER_PIEZO_SPK_STATE"
...
.field public static final ACTION_FINGERSCAN_ERASE_ALL:Ljava/lang/String; = "com.pantech.intent.action.FINGERSCAN_ERASE_ALL"

.field public static final ACTION_FINGER_KEY_DOUBLE_PRESS_LCD_OFF:Ljava/lang/String; = "com.pantech.intent.action.FINGER_KEY_DOUBLE_PRESS_LCD_OFF"

.field public static final ACTION_FINGER_KEY_PRESS:Ljava/lang/String; = "com.pantech.intent.action.FINGER_KEY_PRESS"
...
.field public static final ACTION_LOGONOFF_STATUS:Ljava/lang/String; = "com.pantech.intent.action.LOGONOFF_STATUS"
...
.field public static final ACTION_PEN_IN:Ljava/lang/String; = "com.pantech.intent.action.PEN_IN"

.field public static final ACTION_PEN_OUT:Ljava/lang/String; = "com.pantech.intent.action.PEN_OUT"
...
.field public static final ACTION_SCREENSHOT_COMPLETE:Ljava/lang/String; = "com.pantech.intent.action.SCREENSHOT_COMPLETE"
...
.field public static final ACTION_SET_HOME_KEY:Ljava/lang/String; = "com.pantech.intent.action.SET_HOME_KEY"
...
.field private mAppLockOrigInfo:Landroid/content/AppLockInfo;
...
.method public constructor <init>(Landroid/content/Intent;)V
    ...
    .line 3856
    :cond_4
    iget-object v0, p1, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;
    ...
    iget-object v1, p1, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;

    invoke-direct {v0, v1}, Landroid/content/AppLockInfo;-><init>(Landroid/content/AppLockInfo;)V

    iput-object v0, p0, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;
...
.method public static makeOriginalIntent(Landroid/content/Intent;)Landroid/content/Intent;
    .locals 4
    .param p0, "appLockIntent"    # Landroid/content/Intent;

    .prologue
    .line 3790
    if-eqz p0, :cond_1

    iget-object v2, p0, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;
    ...
    iget-object v0, p0, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;

    .line 3794
    .local v0, "appLockInfo":Landroid/content/AppLockInfo;
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getAction()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v1, Landroid/content/Intent;->mAction:Ljava/lang/String;

    .line 3795
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getData()Landroid/net/Uri;

    move-result-object v2

    iput-object v2, v1, Landroid/content/Intent;->mData:Landroid/net/Uri;

    .line 3796
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getType()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v1, Landroid/content/Intent;->mType:Ljava/lang/String;

    .line 3797
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getPackage()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v1, Landroid/content/Intent;->mPackage:Ljava/lang/String;

    .line 3798
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getComponent()Landroid/content/ComponentName;

    move-result-object v2

    iput-object v2, v1, Landroid/content/Intent;->mComponent:Landroid/content/ComponentName;

    .line 3799
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getFlags()I

    move-result v2

    iput v2, v1, Landroid/content/Intent;->mFlags:I
    ...
    invoke-virtual {v0}, Landroid/content/AppLockInfo;->getCategories()Ljava/util/Set;
    ...
    iput-object v3, v1, Landroid/content/Intent;->mCategories:Landroid/util/ArraySet;

    .line 3815
    .end local v0    # "appLockInfo":Landroid/content/AppLockInfo;
...
# virtual methods
.method public addAppLockInfo()Z
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroid/content/AppLockInfo;-><init>(Landroid/content/Intent;)V
...
.method public hasAppLockInfo()Z
    .locals 1
...
.method public readFromParcel(Landroid/os/Parcel;)V
    ...
    .line 7207
    sget-object v2, Landroid/content/AppLockInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-interface {v2, p1}, Landroid/os/Parcelable$Creator;->createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/content/AppLockInfo;

    iput-object v2, p0, Landroid/content/Intent;->mAppLockOrigInfo:Landroid/content/AppLockInfo;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v2, p1, p2}, Landroid/content/AppLockInfo;->writeToParcel(Landroid/os/Parcel;I)V
