...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/Editor$EditorActionMode;,
...
.field mSelectionActionMode:Landroid/widget/Editor$EditorActionMode;
...
.field private mShowSuggestinSpan:Z
...
.method static synthetic access$2500(Landroid/widget/Editor;)Z
    ...
    .prologue
    .line 128
    invoke-direct {p0}, Landroid/widget/Editor;->isShowSuggestionSpan()Z
...
.method static synthetic access$2600(Landroid/widget/Editor;Z)V
    .locals 0
    .param p0, "x0"    # Landroid/widget/Editor;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 128
    invoke-direct {p0, p1}, Landroid/widget/Editor;->setShowSuggestionSpan(Z)V
...
.method static synthetic access$3000(Landroid/widget/Editor;)V
    ...
    .prologue
    .line 128
    invoke-direct {p0}, Landroid/widget/Editor;->hideSelectionPointCursorController()V
...
.method private hideSelectionPointCursorController()V
    .locals 1
...
.method private isShowSuggestionSpan()Z
    .locals 1

    .prologue
    .line 1645
    iget-boolean v0, p0, Landroid/widget/Editor;->mShowSuggestinSpan:Z
...
.method private setShowSuggestionSpan(Z)V
    .locals 0
    .param p1, "showSuggestinSpan"    # Z

    .prologue
    .line 1649
    iput-boolean p1, p0, Landroid/widget/Editor;->mShowSuggestinSpan:Z
...
.method onDrop(Landroid/view/DragEvent;)V
    ...
    invoke-virtual/range {v25 .. v25}, Landroid/widget/TextView;->getMaxLength()I
    ...
    invoke-interface/range {v24 .. v25}, Ljava/lang/CharSequence;->charAt(I)C
...
.method public performLongClick(Z)Z
    ...
    iget-object v6, p0, Landroid/widget/Editor;->mSelectionActionMode:Landroid/widget/Editor$EditorActionMode;
...
.method startSelectionActionMode()Z
    ...
    new-instance v2, Landroid/widget/Editor$EditorActionMode;
    ...
    invoke-direct {v2, p0, v6, v0}, Landroid/widget/Editor$EditorActionMode;-><init>(Landroid/widget/Editor;Landroid/content/Context;Landroid/view/ActionMode$Callback;)V

    .line 1590
    .local v2, "mode":Landroid/widget/Editor$EditorActionMode;
    iput-object v2, p0, Landroid/widget/Editor;->mSelectionActionMode:Landroid/widget/Editor$EditorActionMode;

    .line 1591
    invoke-virtual {v2}, Landroid/widget/Editor$EditorActionMode;->dispatchOnCreate()Z
    ...
    .line 1592
    invoke-virtual {v2}, Landroid/widget/Editor$EditorActionMode;->invalidate()V
...
.method protected stopSelectionActionMode()V
    ...
    .prologue
    .line 1681
    iget-object v0, p0, Landroid/widget/Editor;->mSelectionActionMode:Landroid/widget/Editor$EditorActionMode;
    ...
    invoke-virtual {v0}, Landroid/widget/Editor$EditorActionMode;->finish()V
