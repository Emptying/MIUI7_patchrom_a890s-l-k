...
.field static final TRANSACTION_doWiFiCustBooleanCommand:I = 0x44

.field static final TRANSACTION_doWiFiCustIntCommand:I = 0x45

.field static final TRANSACTION_doWiFiCustStringCommand:I = 0x46
...
.field static final TRANSACTION_getCheckManualConnection:I = 0x37

.field static final TRANSACTION_getCheckManualQuery:I = 0x3b
...
.field static final TRANSACTION_getDisconnectionPriority:I = 0x34

.field static final TRANSACTION_getFER_PERCommand:I = 0x3f

.field static final TRANSACTION_getFrequencyBand:I = 0x11

.field static final TRANSACTION_getOEMScanResults:I = 0x49

.field static final TRANSACTION_getReCheckManualConnection:I = 0x39

.field static final TRANSACTION_getScanResults:I = 0x8

.field static final TRANSACTION_getTxpwrCommand:I = 0x3e

.field static final TRANSACTION_getWifiApConfiguration:I = 0x1f

.field static final TRANSACTION_getWifiApEnabledState:I = 0x1e

.field static final TRANSACTION_getWifiAuthState:I = 0x31

.field static final TRANSACTION_getWifiConnectState:I = 0x30

.field static final TRANSACTION_getWifiEnabledState:I = 0xe

.field static final TRANSACTION_getWifiNativeCommand:I = 0x40
...
.field static final TRANSACTION_initConfiguration:I = 0x3d
...
.field static final TRANSACTION_isHiddenNetworksFull:I = 0x43
...
.field static final TRANSACTION_removePseudonymId:I = 0x42

.field static final TRANSACTION_requestBatchedScan:I = 0x2b

.field static final TRANSACTION_saveConfiguration:I = 0x13

.field static final TRANSACTION_setCheckManualConnection:I = 0x36

.field static final TRANSACTION_setCheckManualQuery:I = 0x3a

.field static final TRANSACTION_setConnectionPriorityMode:I = 0x33

.field static final TRANSACTION_setCountryCode:I = 0xf

.field static final TRANSACTION_setDisableEnableAllNetworks:I = 0x47

.field static final TRANSACTION_setDisconnectionPriority:I = 0x32

.field static final TRANSACTION_setFrequencyBand:I = 0x10

.field static final TRANSACTION_setManualConnection:I = 0x35

.field static final TRANSACTION_setProfileManualConnection:I = 0x3c

.field static final TRANSACTION_setReCheckManualConnection:I = 0x38

.field static final TRANSACTION_setRealmForOllehWiFi:I = 0x4a
...
.field static final TRANSACTION_showConfInfo:I = 0x41

.field static final TRANSACTION_sizeofScanResults:I = 0x48
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 551
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getWifiConnectState()Ljava/lang/String;
    ...
    .line 559
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getWifiAuthState()Ljava/lang/String;
    ...
    .line 569
    .local v0, "_arg0":I
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setDisconnectionPriority(I)Z
    ...
    .line 579
    .restart local v0    # "_arg0":I
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setConnectionPriorityMode(I)Z
    ...
    .line 587
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getDisconnectionPriority()I
    ...
    .local v0, "_arg0":Z
    :goto_11
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setManualConnection(Z)Z
    ...
    :goto_12
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setCheckManualConnection(Z)Z
    ...
    .line 615
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getCheckManualConnection()Z
    ...
    .restart local v0    # "_arg0":Z
    :goto_13
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setReCheckManualConnection(Z)Z
    ...
    .line 633
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getReCheckManualConnection()Z
    ...
    .restart local v0    # "_arg0":Z
    :goto_14
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setCheckManualQuery(Z)Z
    ...
    .line 651
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getCheckManualQuery()Z
    ...
    .local v1, "_arg1":Z
    :goto_15
    invoke-virtual {p0, v0, v1}, Landroid/net/wifi/IWifiManager$Stub;->setProfileManualConnection(IZ)Z
    ...
    .line 671
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->initConfiguration()Z
    ...
    .line 679
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getTxpwrCommand()Ljava/lang/String;
    ...
    .line 687
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->getFER_PERCommand()Ljava/lang/String;
    ...
    .line 697
    .local v0, "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->getWifiNativeCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 705
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->showConfInfo()Ljava/lang/String;
    ...
    .line 713
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->removePseudonymId()Z
    ...
    .line 721
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->isHiddenNetworksFull()Z
    ...
    .line 731
    .restart local v0    # "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->doWiFiCustBooleanCommand(Ljava/lang/String;)Z
    ...
    .line 741
    .restart local v0    # "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->doWiFiCustIntCommand(Ljava/lang/String;)I
    ...
    .line 751
    .restart local v0    # "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->doWiFiCustStringCommand(Ljava/lang/String;)Ljava/lang/String;
    ...
    .local v0, "_arg0":Z
    :goto_16
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setDisableEnableAllNetworks(Z)Z
    ...
    .line 769
    invoke-virtual {p0}, Landroid/net/wifi/IWifiManager$Stub;->sizeofScanResults()I
    ...
    .line 779
    .local v0, "_arg0":I
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->getOEMScanResults(I)Landroid/net/wifi/ScanResult;

    move-result-object v4

    .line 780
    .local v4, "_result":Landroid/net/wifi/ScanResult;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 783
    invoke-virtual {v4, p3, v9}, Landroid/net/wifi/ScanResult;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 792
    .end local v0    # "_arg0":I
    .end local v4    # "_result":Landroid/net/wifi/ScanResult;
    :sswitch_4a
    const-string v10, "android.net.wifi.IWifiManager"
    ...
    .line 795
    .local v0, "_arg0":Ljava/lang/String;
    invoke-virtual {p0, v0}, Landroid/net/wifi/IWifiManager$Stub;->setRealmForOllehWiFi(Ljava/lang/String;)Z
