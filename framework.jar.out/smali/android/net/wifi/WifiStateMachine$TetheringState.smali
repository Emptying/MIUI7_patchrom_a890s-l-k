...
.method public enter()V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$31304(Landroid/net/wifi/WifiStateMachine;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$31400(Landroid/net/wifi/WifiStateMachine;Ljava/util/ArrayList;)Z
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$31500(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v3

    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$31600(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$31300(Landroid/net/wifi/WifiStateMachine;)I
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$31700(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiStateMachine;->access$30300(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;

    move-result-object v3

    # invokes: Landroid/net/wifi/WifiStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$31800(Landroid/net/wifi/WifiStateMachine;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiStateMachine;->access$31900(Landroid/net/wifi/WifiStateMachine;I)V
    ...
    invoke-static {v2, p1}, Landroid/net/wifi/WifiStateMachine;->access$32000(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
