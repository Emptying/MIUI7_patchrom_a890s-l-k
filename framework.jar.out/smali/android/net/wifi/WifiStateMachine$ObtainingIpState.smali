...
.method public enter()V
    ...
    invoke-virtual {v5, v6}, Landroid/net/wifi/WifiStateMachine;->LGT_Connect_DB_Process(I)V
    ...
    invoke-virtual {v5, v9}, Landroid/net/wifi/WifiStateMachine;->LGT_Connect_DB_Process(I)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->log(Ljava/lang/String;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$24200(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    .line 5600
    :sswitch_0
    iget-object v2, p0, Landroid/net/wifi/WifiStateMachine$ObtainingIpState;->this$0:Landroid/net/wifi/WifiStateMachine;
    ...
    invoke-static {v2, v1}, Landroid/net/wifi/WifiStateMachine;->access$21900(Landroid/net/wifi/WifiStateMachine;Landroid/net/DhcpResults;)V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiStateMachine;->access$22000(Landroid/net/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$22300(Landroid/net/wifi/WifiStateMachine;)V
    ...
    invoke-static {v1, p1}, Landroid/net/wifi/WifiStateMachine;->access$24500(Landroid/net/wifi/WifiStateMachine;Landroid/os/Message;)V
    ...
    invoke-static {v1}, Landroid/net/wifi/WifiStateMachine;->access$14500(Landroid/net/wifi/WifiStateMachine;)Ljava/lang/String;
    ...
    const-string v3, "[WIFI_TEST] CMD_SET_COUNTRY_CODE set country code "
    ...
    invoke-virtual {v1, v2}, Landroid/net/wifi/WifiNative;->setCountryCode(Ljava/lang/String;)Z
    ...
    const-string v3, "Failed to set country code "
    ...
    # invokes: Landroid/net/wifi/WifiStateMachine;->loge(Ljava/lang/String;)V
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateMachine;->access$24800(Landroid/net/wifi/WifiStateMachine;Ljava/lang/String;)V
    ...
    const-string v2, "[WIFI_TEST] CMD_SET_COUNTRY_CODE () kr"
