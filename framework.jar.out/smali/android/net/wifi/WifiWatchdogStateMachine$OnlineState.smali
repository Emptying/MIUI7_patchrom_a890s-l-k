...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$11800(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v2, v1}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$1102(Landroid/net/wifi/WifiWatchdogStateMachine;Z)Z

    .line 1315
    const-string/jumbo v2, "wlan.debug.tistrp"
    ...
    .line 1316
    .local v0, "tistrp_enable":Ljava/lang/String;
    iget-object v2, p0, Landroid/net/wifi/WifiWatchdogStateMachine$OnlineState;->this$0:Landroid/net/wifi/WifiWatchdogStateMachine;
    ...
    const-string v4, "OnlineState # tistrp_enable: "
    ...
    invoke-static {v2, v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$11900(Landroid/net/wifi/WifiWatchdogStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3500(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/net/wifi/WifiWatchdogStateMachine$OnlineWatchState;

    move-result-object v3

    # invokes: Landroid/net/wifi/WifiWatchdogStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$12000(Landroid/net/wifi/WifiWatchdogStateMachine;Lcom/android/internal/util/IState;)V
