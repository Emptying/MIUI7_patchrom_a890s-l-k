...
.field public static final USER_ACTIVITY_EVENT_IRMOTION:I = 0x5
...
.method public changeDebugMode(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->changeDebugMode(Z)V
    :try_end_0
...
.method public getDebugInit()Z
    ...
    invoke-interface {v1}, Landroid/os/IPowerManager;->getDebugInit()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setButtonLight(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->handleButtonLight(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setButtonLightsOnMode(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->setButtonLightsOnMode(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDebugInit()V
    ...
    invoke-interface {v0}, Landroid/os/IPowerManager;->setDebugInit()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDispatcherDebug(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->setDispatcherDebug(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setReaderDebug(Z)V
    ...
    invoke-interface {v0, p1}, Landroid/os/IPowerManager;->setReaderDebug(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
