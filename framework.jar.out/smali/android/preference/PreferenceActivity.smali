...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 543
    .local v11, "initialFragment":Ljava/lang/String;
    invoke-virtual/range {p0 .. p0}, Landroid/preference/PreferenceActivity;->getIntent()Landroid/content/Intent;
    ...
    .line 551
    .local v8, "headers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/preference/PreferenceActivity$Header;>;"
    if-eqz v8, :cond_1
    ...
    .line 595
    .end local v6    # "curHeader":I
    .end local v8    # "headers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/preference/PreferenceActivity$Header;>;"
    :cond_1
    :goto_3
    if-eqz v11, :cond_e
    ...
    .line 601
    .local v15, "initialTitleStr":Ljava/lang/CharSequence;
    if-eqz v12, :cond_d
    ...
    .line 603
    .local v13, "initialShortTitleStr":Ljava/lang/CharSequence;
    :goto_4
    move-object/from16 v0, p0

    invoke-virtual {v0, v15, v13}, Landroid/preference/PreferenceActivity;->showBreadCrumbs(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)V

    .line 635
    .end local v13    # "initialShortTitleStr":Ljava/lang/CharSequence;
    .end local v15    # "initialTitleStr":Ljava/lang/CharSequence;
    :cond_2
    :goto_5
    invoke-virtual/range {p0 .. p0}, Landroid/preference/PreferenceActivity;->getIntent()Landroid/content/Intent;
    ...
    .line 528
    .end local v9    # "hidingHeaders":Z
    .end local v10    # "initialArguments":Landroid/os/Bundle;
    .end local v11    # "initialFragment":Ljava/lang/String;
    .end local v12    # "initialShortTitle":I
    .end local v14    # "initialTitle":I
    ...
    .line 541
    .restart local v9    # "hidingHeaders":Z
    :cond_8
    const/16 v20, 0x0
    ...
    .line 561
    .restart local v10    # "initialArguments":Landroid/os/Bundle;
    .restart local v11    # "initialFragment":Ljava/lang/String;
    .restart local v12    # "initialShortTitle":I
    .restart local v14    # "initialTitle":I
    :cond_9
    if-eqz v11, :cond_b
    ...
    invoke-virtual {v0, v11, v10}, Landroid/preference/PreferenceActivity;->switchToHeader(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 568
    .restart local v15    # "initialTitleStr":Ljava/lang/CharSequence;
    if-eqz v12, :cond_a
    ...
    .line 570
    .restart local v13    # "initialShortTitleStr":Ljava/lang/CharSequence;
    :goto_8
    move-object/from16 v0, p0
    ...
    .line 584
    .local v7, "h":Landroid/preference/PreferenceActivity$Header;
    move-object/from16 v0, p0

    invoke-virtual {v0, v7}, Landroid/preference/PreferenceActivity;->switchToHeader(Landroid/preference/PreferenceActivity$Header;)V

    goto/16 :goto_3

    .line 586
    .end local v7    # "h":Landroid/preference/PreferenceActivity$Header;
    :cond_c
    move-object/from16 v0, p0
    ...
    .line 669
    .restart local v4    # "backButton":Landroid/widget/Button;
    .restart local v5    # "buttonText":Ljava/lang/String;
