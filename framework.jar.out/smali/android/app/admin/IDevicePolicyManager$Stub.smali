...
.field static final TRANSACTION_getDataNetworkDisabled:I = 0x3b
...
.field static final TRANSACTION_getMDM:I = 0x39
...
.field static final TRANSACTION_setCoverState:I = 0x3d

.field static final TRANSACTION_setDataNetworkDisabled:I = 0x3a

.field static final TRANSACTION_setDeviceOwner:I = 0x32

.field static final TRANSACTION_setFingerScanUsed:I = 0x3e

.field static final TRANSACTION_setGlobalProxy:I = 0x1f

.field static final TRANSACTION_setKeyguardDisabledFeatures:I = 0x26

.field static final TRANSACTION_setMDM:I = 0x38
...
.field static final TRANSACTION_setTouchMode:I = 0x3c
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .restart local v22    # "_result":Landroid/content/ComponentName;
    :cond_1c
    const/4 v3, 0x0
    ...
    .line 738
    .local v24, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 744
    .end local v4    # "_arg0":I
    .end local v24    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/content/ComponentName;>;"
    :sswitch_2b
    const-string v3, "android.app.admin.IDevicePolicyManager"
    ...
    .line 833
    invoke-virtual/range {v3 .. v12}, Landroid/app/admin/IDevicePolicyManager$Stub;->setActivePasswordState(IIIIIIIII)V
    ...
    .line 932
    invoke-virtual/range {v13 .. v19}, Landroid/app/admin/IDevicePolicyManager$Stub;->setMDM(ILandroid/content/ComponentName;Ljava/util/List;Ljava/util/List;II)V
    ...
    .line 954
    invoke-virtual/range {v3 .. v8}, Landroid/app/admin/IDevicePolicyManager$Stub;->getMDM(ILandroid/content/ComponentName;Ljava/lang/String;II)Ljava/util/List;
    ...
    invoke-virtual {v0, v4, v5, v6}, Landroid/app/admin/IDevicePolicyManager$Stub;->setDataNetworkDisabled(Landroid/content/ComponentName;ZI)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/app/admin/IDevicePolicyManager$Stub;->getDataNetworkDisabled(Landroid/content/ComponentName;I)Z
    ...
    invoke-virtual {v0, v4, v5, v6}, Landroid/app/admin/IDevicePolicyManager$Stub;->setTouchMode(IILandroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v4}, Landroid/app/admin/IDevicePolicyManager$Stub;->setCoverState(Z)V
    ...
    invoke-virtual {v0, v4, v5}, Landroid/app/admin/IDevicePolicyManager$Stub;->setFingerScanUsed(IZ)V
