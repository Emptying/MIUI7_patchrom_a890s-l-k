...
.field private mDualPhoneWindowWrapper:Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;
...
.field mRearGestureWrapper:Lcom/android/internal/policy/impl/RearGestureWrapper;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 203
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mBackgroundResource:I

    .line 207
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mFrameResource:I

    .line 209
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTextColor:I

    .line 211
    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitle:Ljava/lang/CharSequence;

    .line 213
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mTitleColor:I

    .line 215
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mAlwaysReadCloseOnTouchAttr:Z
    ...
    .line 226
    iput v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mUiOptions:I
    ...
    .line 253
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mIsPantechTheme:Z

    .line 254
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mInitPantechTheme:Z
    ...
    .line 271
    new-instance v1, Lcom/android/internal/policy/impl/RearGestureWrapper;

    invoke-direct {v1, p1, p0}, Lcom/android/internal/policy/impl/RearGestureWrapper;-><init>(Landroid/content/Context;Landroid/view/Window;)V

    iput-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mRearGestureWrapper:Lcom/android/internal/policy/impl/RearGestureWrapper;

    .line 273
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getRearCallback()Landroid/view/Window$RearCallback;
    ...
    .line 276
    new-instance v1, Landroid/app/OnRearTouchListener;

    invoke-direct {v1}, Landroid/app/OnRearTouchListener;-><init>()V

    invoke-virtual {p0, v1}, Lcom/android/internal/policy/impl/PhoneWindow;->setRearCallback(Landroid/view/Window$RearCallback;)V
...
.method static synthetic access$1900(Lcom/android/internal/policy/impl/PhoneWindow;)Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/policy/impl/PhoneWindow;

    .prologue
    .line 122
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDualPhoneWindowWrapper:Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;
...
.method private installDecor()V
    ...
    .line 3362
    iget-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDualPhoneWindowWrapper:Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;

    if-nez v7, :cond_1

    .line 3363
    invoke-static {p0}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->makeVegaPhoneWinodw(Landroid/view/Window;)Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;

    move-result-object v7

    iput-object v7, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDualPhoneWindowWrapper:Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;
    ...
    invoke-virtual {v7}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->updateWindowAttriutes()V
...
.method private openPanel(Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mIsPantechTheme:Z
    ...
    .line 713
    .local v19, "shownPanelParent":Landroid/view/ViewParent;
    if-eqz v19, :cond_9
    ...
    .end local v19    # "shownPanelParent":Landroid/view/ViewParent;
    move-object/from16 v0, p1
    ...
    iget-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mInitPantechTheme:Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mIsPantechTheme:Z
    ...
    iput-boolean v4, v0, Lcom/android/internal/policy/impl/PhoneWindow;->mInitPantechTheme:Z

    .line 691
    .end local v17    # "outValue":Landroid/util/TypedValue;
    :cond_e
    move-object/from16 v0, p0
    ...
    .line 686
    .end local v10    # "backgroundResId":I
    .restart local v17    # "outValue":Landroid/util/TypedValue;
    :cond_10
    const/4 v4, 0x0
    ...
    const-string v5, "Window token for openPanel is NULL"
...
.method private reopenMenu(Z)V
    ...
    .line 1188
    invoke-virtual {p0, v4}, Lcom/android/internal/policy/impl/PhoneWindow;->closePanel(I)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 537
    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mDualPhoneWindowWrapper:Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;
    ...
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->updateWindowAttriutes()V
...
.method public final onKeyUpPanel(ILandroid/view/KeyEvent;)V
    ...
    instance-of v5, v1, Lcom/android/internal/app/ActionBarImpl$ActionModeImpl;
    ...
    const-string v6, "show OverFlowMenu"
    ...
    check-cast v1, Lcom/android/internal/app/ActionBarImpl$ActionModeImpl;

    .end local v1    # "mode":Landroid/view/ActionMode;
    invoke-virtual {v1, v0}, Lcom/android/internal/app/ActionBarImpl$ActionModeImpl;->onMenuModeChange(Lcom/android/internal/view/menu/MenuBuilder;)V

    goto :goto_0

    .line 970
    .end local v0    # "menu":Lcom/android/internal/view/menu/MenuBuilder;
    .restart local v1    # "mode":Landroid/view/ActionMode;
    :cond_2
    const-string v5, "PhoneWindow"

    const-string v6, "Custom ActionMode can\'t show OverflowMenu by menu key."
...
.method onOptionsPanelRotationChanged()V
    ...
    .line 1287
    :cond_1
    iget-object v5, v2, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->decorView:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    if-eqz v5, :cond_3

    iget-object v5, v2, Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;->decorView:Lcom/android/internal/policy/impl/PhoneWindow$DecorView;

    invoke-virtual {v5}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1292
    iget-boolean v5, p0, Lcom/android/internal/policy/impl/PhoneWindow;->mIsPantechTheme:Z
    ...
    .line 1294
    .local v4, "wwm":Landroid/view/WindowManager;
    if-eqz v4, :cond_2
    ...
    invoke-virtual {v5, v6}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->setWindowBackground(Landroid/graphics/drawable/Drawable;)V

    .line 1307
    .end local v1    # "rotation":I
    .end local v4    # "wwm":Landroid/view/WindowManager;
    :cond_2
    :goto_2
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindow;->getWindowManager()Landroid/view/WindowManager;
    ...
    invoke-interface {v3, v5, v0}, Landroid/view/ViewManager;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .restart local v4    # "wwm":Landroid/view/WindowManager;
    :cond_4
    const/4 v5, 0x3
...
.method public onWindowVegaAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->onWindowVegaAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
...
.method public onWinodwStatusChanged(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->onWinodwStatusChanged(I)V
...
.method public setMultiWindowStateChangeCallback(Landroid/view/Window$MultiWindowStateChangeCallback;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/VegaPhoneWindowWrapper;->setMultiWindowStateChangeCallback(Landroid/view/Window$MultiWindowStateChangeCallback;)V
