...
.field final synthetic val$alwaysOnTopService:Lcom/pantech/server/aot/AlwaysOnTopManagerService;
...
.method constructor <init>(Lcom/android/server/ServerThread;ZLandroid/content/Context;Lcom/android/server/MountService;Lcom/android/server/BatteryService;Lcom/android/server/NetworkManagementService;Lcom/android/server/net/NetworkStatsService;Lcom/android/server/net/NetworkPolicyManagerService;Lcom/android/server/ConnectivityService;Lcom/android/server/DockObserver;Lcom/android/server/usb/UsbService;Lcom/android/server/TwilightService;Lcom/android/server/UiModeManagerService;Lcom/android/server/RecognitionManagerService;Lcom/android/server/AppWidgetService;ZLcom/android/server/WallpaperManagerService;Lcom/android/server/InputMethodManagerService;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LocationManagerService;Lcom/android/server/CountryDetectorService;Lcom/android/server/NetworkTimeUpdateService;Lcom/android/server/CommonTimeManagementService;Lcom/android/server/TextServicesManagerService;Lcom/android/server/dreams/DreamManagerService;Lcom/android/server/AssetAtlasService;Lcom/android/server/input/InputManagerService;Lcom/android/server/TelephonyRegistry;Lcom/android/server/MSimTelephonyRegistry;Lcom/android/server/print/PrintManagerService;Lcom/android/server/media/MediaRouterService;Lcom/pantech/server/aot/AlwaysOnTopManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/ServerThread$2;->val$alwaysOnTopService:Lcom/pantech/server/aot/AlwaysOnTopManagerService;
...
.method public run()V
    ...
    :goto_1a
    :try_start_1b
    iget-object v1, p0, Lcom/android/server/ServerThread$2;->val$alwaysOnTopService:Lcom/pantech/server/aot/AlwaysOnTopManagerService;

    if-eqz v1, :cond_1b

    iget-object v1, p0, Lcom/android/server/ServerThread$2;->val$alwaysOnTopService:Lcom/pantech/server/aot/AlwaysOnTopManagerService;

    invoke-virtual {v1}, Lcom/pantech/server/aot/AlwaysOnTopManagerService;->systemReady()V
    :try_end_1b
    ...
    const-string v2, "making Always On Top Service ready"
