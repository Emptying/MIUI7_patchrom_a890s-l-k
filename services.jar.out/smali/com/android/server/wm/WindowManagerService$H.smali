...
.field public static final REPORT_SPLIT_BAR_HIDE:I = 0x30d42

.field public static final REPORT_SPLIT_BAR_SHOW:I = 0x30d41
...
.field public static final SPLIT_BAR_OFFSET:I = 0x30d40
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    new-instance v3, Lcom/android/server/wm/WindowManagerService$H$1;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Lcom/android/server/wm/WindowManagerService$H$1;-><init>(Lcom/android/server/wm/WindowManagerService$H;)V
    ...
    iget-object v12, v0, Lcom/android/server/wm/AppWindowToken;->appToken:Landroid/view/IApplicationToken;

    invoke-interface/range {v2 .. v12}, Landroid/view/WindowManagerPolicy;->addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;IIIILandroid/view/IApplicationToken;)Landroid/view/View;
    :try_end_5
    ...
    iget v2, v2, Lcom/android/server/wm/WindowManagerService;->mSplitBarShow:I
    ...
    .line 8583
    .local v15, "currentStack":Lcom/android/server/wm/TaskStack;
    :goto_a
    if-eqz v15, :cond_0

    invoke-virtual {v15}, Lcom/android/server/wm/TaskStack;->isHomeStack()Z
    ...
    iput v3, v2, Lcom/android/server/wm/WindowManagerService;->mSplitBarShow:I
    ...
    const-string v4, "android.intent.action.multiwindow_center_bar_show"
    ...
    .line 8582
    .end local v15    # "currentStack":Lcom/android/server/wm/TaskStack;
    :cond_1b
    const/4 v15, 0x0
    ...
    const-string v4, "android.intent.action.multiwindow_center_bar_hide"
