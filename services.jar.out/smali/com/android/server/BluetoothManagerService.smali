...
.field private static final SHARED_PREFERENCE_BT_MDM_UPDATED:Ljava/lang/String; = "bt_mdm_policy_updated"
...
.field private mBluetoothA2dp:Ljava/util/concurrent/atomic/AtomicReference;
...
.field private mBluetoothHeadset:Ljava/util/concurrent/atomic/AtomicReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/atomic/AtomicReference",
            "<",
...
.field private mBluetoothInputDevice:Ljava/util/concurrent/atomic/AtomicReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/atomic/AtomicReference",
            "<",
            "Landroid/bluetooth/BluetoothInputDevice;",
            ">;"
        }
    .end annotation
.end field
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothA2dp:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v1, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothHeadset:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v1, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothInputDevice:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v1, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothPan:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v1, p0, Lcom/android/server/BluetoothManagerService;->mServiceListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;
    ...
    .line 411
    iput v3, p0, Lcom/android/server/BluetoothManagerService;->mAclLinkCount:I
...
.method static synthetic access$1200(Lcom/android/server/BluetoothManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$1300(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mServiceListener:Landroid/bluetooth/BluetoothProfile$ServiceListener;

    return-object v0
.end method

.method static synthetic access$1400(Lcom/android/server/BluetoothManagerService;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothPan:Ljava/util/concurrent/atomic/AtomicReference;

    return-object v0
.end method

.method static synthetic access$1500(Lcom/android/server/BluetoothManagerService;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothInputDevice:Ljava/util/concurrent/atomic/AtomicReference;

    return-object v0
.end method

.method static synthetic access$1600(Lcom/android/server/BluetoothManagerService;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothHeadset:Ljava/util/concurrent/atomic/AtomicReference;

    return-object v0
.end method

.method static synthetic access$1700(Lcom/android/server/BluetoothManagerService;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;

    .prologue
    .line 68
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothA2dp:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static synthetic access$1800(Lcom/android/server/BluetoothManagerService;)I
    ...
    .prologue
    .line 68
    iget v0, p0, Lcom/android/server/BluetoothManagerService;->mAclLinkCount:I

    return v0
.end method

.method static synthetic access$1808(Lcom/android/server/BluetoothManagerService;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    ...
    iput v1, p0, Lcom/android/server/BluetoothManagerService;->mAclLinkCount:I

    return v0
.end method

.method static synthetic access$1810(Lcom/android/server/BluetoothManagerService;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3102(Lcom/android/server/BluetoothManagerService;Landroid/bluetooth/IBluetoothGatt;)Landroid/bluetooth/IBluetoothGatt;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3200(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/IQBluetooth;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3202(Lcom/android/server/BluetoothManagerService;Landroid/bluetooth/IQBluetooth;)Landroid/bluetooth/IQBluetooth;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3400(Lcom/android/server/BluetoothManagerService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3500(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/IBluetoothCallback;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method public enable(Ljava/lang/String;)Z
    ...
    .line 623
    :cond_1
    invoke-virtual {p0}, Lcom/android/server/BluetoothManagerService;->getBluetoothDevicePolicy()I
...
.method public getBluetoothDevicePolicy()I
    ...
    .local v0, "btPolicy":I
    :try_start_0
    const-string v4, "android.app.admin.DevicePolicyManager"
    ...
    const-string v4, "getBluetoothDisabled"
...
.method public getPowerOffPossible()Z
    ...
    const-string v2, "mAclLinkCount is opened: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p0, Lcom/android/server/BluetoothManagerService;->mAclLinkCount:I
...
.method public unbindAndFinish()V
    ...
    .line 693
    iput v4, p0, Lcom/android/server/BluetoothManagerService;->mAclLinkCount:I
