...
.method handleFinished()V
    ...
    .line 418
    :try_start_0
    # operator++ for: Lcom/android/server/MountService;->CurUnmountVolCNT:I
    invoke-static {}, Lcom/android/server/MountService;->access$308()I
    ...
    const-string v4, " #> - handleFinished >> TotalUnmountVolCNT = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    # getter for: Lcom/android/server/MountService;->TotalUnmountVolCNT:I
    invoke-static {}, Lcom/android/server/MountService;->access$400()I
    ...
    const-string v4, " #> - handleFinished >> CurUnmountVolCNT = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    # getter for: Lcom/android/server/MountService;->CurUnmountVolCNT:I
    invoke-static {}, Lcom/android/server/MountService;->access$300()I
    ...
    const-string v4, "### handleFinished >> observer.onShutDownComplete ret = "
    ...
    const-string v3, "### handleFinished  but  not Completed"
