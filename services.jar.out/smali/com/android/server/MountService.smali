...
.field private static CurUnmountVolCNT:I = 0x0
...
.field private static TotalUnmountVolCNT:I = 0x0
...
.method static constructor <clinit>()V
    ...
    .line 138
    sput v0, Lcom/android/server/MountService;->TotalUnmountVolCNT:I

    .line 139
    sput v0, Lcom/android/server/MountService;->CurUnmountVolCNT:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 236
    iput-boolean v1, p0, Lcom/android/server/MountService;->mShared:Z
    ...
    const-string v2, "secondary path : "
...
.method static synthetic access$300()I
    ...
    .prologue
    .line 116
    sget v0, Lcom/android/server/MountService;->CurUnmountVolCNT:I
...
.method static synthetic access$308()I
    ...
    sput v1, Lcom/android/server/MountService;->CurUnmountVolCNT:I
...
.method static synthetic access$400()I
    ...
    .prologue
    .line 116
    sget v0, Lcom/android/server/MountService;->TotalUnmountVolCNT:I
...
.method private notifyShareAvailabilityChange(Z)V
    ...
    iget-boolean v5, p0, Lcom/android/server/MountService;->mShared:Z
    ...
    const-string v6, "MountService#AvailabilityChange"

    invoke-direct {v5, p0, v6, v3}, Lcom/android/server/MountService$6;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;)V
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v5, "## Shutting down NOW!!,  Skip  send Intent [ACTION_MEDIA_EJECT] "
    ...
    const-string v5, "##updating volume state Unmounting. ## send Intent ACTION_MEDIA_EJECT "
    ...
    .end local v1    # "shutdownAction":Ljava/lang/String;
    :cond_8
    const/4 v4, 0x6
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    const-string v12, "## mVolumeStates.size() = "
    ...
    const-string v12, "## mVolumeStates.keySet() = "
    ...
    .line 1538
    .local v8, "volumeCNT":I
    const/4 v9, 0x0

    sput v9, Lcom/android/server/MountService;->CurUnmountVolCNT:I

    .line 1539
    const/4 v9, 0x0

    sput v9, Lcom/android/server/MountService;->TotalUnmountVolCNT:I
    ...
    .line 1544
    sget v9, Lcom/android/server/MountService;->TotalUnmountVolCNT:I
    ...
    const-string v12, "handleFinished >> TotalUnmountVolCNT = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    sget v12, Lcom/android/server/MountService;->TotalUnmountVolCNT:I
    ...
    const-string v12, "handleFinished >> CurUnmountVolCNT = "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    sget v12, Lcom/android/server/MountService;->CurUnmountVolCNT:I
    ...
    const-string v12, "## Volume States  = "
    ...
    const-string v12, "## mVolumeStates Count = "
    ...
    const-string v11, "##MEDIA_MOUNTED##Post a unmount message."
    ...
    .line 1585
    :pswitch_0
    invoke-static {}, Landroid/os/Environment;->getOTGStorageState()Ljava/lang/String;
    ...
    const-string v11, "######## call observer.onShutDownComplete"
...
.method public unregisterListener(Landroid/os/storage/IMountServiceListener;)V
    ...
    iget-object v3, v1, Lcom/android/server/MountService$MountServiceBinderListener;->mListener:Landroid/os/storage/IMountServiceListener;

    invoke-interface {v3}, Landroid/os/storage/IMountServiceListener;->asBinder()Landroid/os/IBinder;
