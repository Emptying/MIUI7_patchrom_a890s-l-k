...
.field private static final DEV_CONFIGURATION_MATCH:Ljava/lang/String; = "DEVPATH=/devices/virtual/switch/dev_configuration"

.field private static final DEV_CONFIGURATION_PATH:Ljava/lang/String; = "/sys/class/switch/dev_configuration/state"

.field private static final FUNCTIONS_PATH:Ljava/lang/String; = "/sys/class/android_usb/android0/functions"

.field private static final HOST_CONFIGURATION_MATCH:Ljava/lang/String; = "DEVPATH=/devices/virtual/switch/host_configuration"

.field private static final HOST_CONFIGURATION_PATH:Ljava/lang/String; = "/sys/class/switch/host_configuration/state"
...
.field private static final MSG_CHANGING_USB_PCMODE:I = 0xd

.field private static final MSG_ENABLE_ADB:I = 0x1

.field private static final MSG_OTG_DEV_CONNECTED:I = 0x8

.field private static final MSG_OTG_DEV_DISCONNECTED:I = 0x9

.field private static final MSG_OTG_DEV_POWER_DISCONNECTED:I = 0xb

.field private static final MSG_OTG_DEV_POWER_LOW_DISCONNECTED:I = 0xc

.field private static final MSG_OTG_HOST_CONNECTED:I = 0x6

.field private static final MSG_OTG_HOST_DISCONNECTED:I = 0x7

.field private static final MSG_OTG_POWER_DISCONNECTED:I = 0xa
...
.field private mDevConfiguration:I

.field private mHandler:Lcom/android/server/usb/UsbDeviceManager$UsbHandler;

.field private final mHasUsbAccessory:Z

.field private mHostConfiguration:I
...
.field private mUsbPantechDevice:Lcom/android/server/usb/UsbPantechDevice;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 245
    new-instance v3, Lcom/android/server/usb/UsbPantechDevice;

    invoke-direct {v3, p1}, Lcom/android/server/usb/UsbPantechDevice;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbPantechDevice:Lcom/android/server/usb/UsbPantechDevice;

    .line 250
    iput-boolean v5, p0, Lcom/android/server/usb/UsbDeviceManager;->isPSTMode:Z
...
.method static synthetic access$1100(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbDebuggingManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$2000(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 75
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->isPSTMode:Z
...
.method static synthetic access$2002(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 75
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->isPSTMode:Z

    return p1
.end method

.method static synthetic access$2100(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbPantechDevice;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;

    .prologue
    .line 75
    iget-object v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mUsbPantechDevice:Lcom/android/server/usb/UsbPantechDevice;

    return-object v0
.end method

.method static synthetic access$2200(Lcom/android/server/usb/UsbDeviceManager;)Landroid/content/Intent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;

    .prologue
    .line 75
    invoke-direct {p0}, Lcom/android/server/usb/UsbDeviceManager;->getCurrentOtgIntent()Landroid/content/Intent;
...
.method static synthetic access$2300(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$400(Lcom/android/server/usb/UsbDeviceManager;IZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # I
    .param p2, "x2"    # Z
    ...
    .prologue
    .line 75
    invoke-direct {p0, p1, p2}, Lcom/android/server/usb/UsbDeviceManager;->host_update_state(IZ)V
...
.method private getCurrentOtgIntent()Landroid/content/Intent;
    .locals 9
    ...
    const-string v5, "/sys/class/switch/host_configuration/state"
    ...
    iput v5, p0, Lcom/android/server/usb/UsbDeviceManager;->mHostConfiguration:I
    ...
    const-string v7, "host_configuration state : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/usb/UsbDeviceManager;->mHostConfiguration:I
    ...
    const-string v5, "/sys/class/switch/dev_configuration/state"
    ...
    iput v5, p0, Lcom/android/server/usb/UsbDeviceManager;->mDevConfiguration:I
    ...
    const-string v7, "dev_configuration state : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/usb/UsbDeviceManager;->mDevConfiguration:I
    ...
    iget v5, p0, Lcom/android/server/usb/UsbDeviceManager;->mHostConfiguration:I
    ...
    const-string v5, "android.hardware.usb.action.OTG_POWER_DISCONNECTED"
    ...
    const-string v6, "FW_VENDOR_ADD_OTG_HOST : File not found!"
    ...
    const-string v6, "FW_VENDOR_ADD_OTG_HOST : IOException"
    ...
    .restart local v3    # "intent":Landroid/content/Intent;
    :cond_1
    iget v5, p0, Lcom/android/server/usb/UsbDeviceManager;->mDevConfiguration:I
    ...
    .end local v3    # "intent":Landroid/content/Intent;
    const-string v5, "android.hardware.usb.action.OTG_DEV_CONNECTED"
    ...
    .end local v3    # "intent":Landroid/content/Intent;
    const-string v5, "android.hardware.usb.action.OTG_HOST_CONNECTED"
...
.method private final host_update_state(IZ)V
    .locals 3
    .param p1, "mode"    # I
    .param p2, "delayed"    # Z
    ...
    const-string v1, "skip to send OTG broadcast before boot completed."
    ...
    :goto_1
    invoke-virtual {v2, p1, v0, v1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendEmptyMessageDelayed(IJ)Z
...
.method public isBlockUsbSettingsPopup(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/usb/UsbPantechDevice;->isBlockUsbSettingsPopup(Z)V
