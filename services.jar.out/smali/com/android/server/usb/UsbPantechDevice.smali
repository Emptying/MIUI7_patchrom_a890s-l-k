...
.method public changeForcedPCMode()Ljava/lang/String;
    ...
    const-string v2, "serial,diag,obex"
...
.method public showAskOnPopup()Z
    ...
    const-string v6, "show_settings_when_usb_connected"

    invoke-static {v5, v6}, Lcom/pantech/providers/skysettings/SKYSystem;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    ...
    const-string v6, "AOT Show Setting  = FALSE"
    ...
    const-string v6, "AOT Show Setting  = TRUE"
    ...
    .line 113
    const-string v5, "gsm.usim.cardtype"
    ...
    const-string v7, "showAskOnPopup card_type : "
    ...
    const-string v7, " return - skip showAskOnPopup"
    ...
    :cond_2
    iget v5, p0, Lcom/android/server/usb/UsbPantechDevice;->mCallState:I
    ...
    const-string v7, "initTelephonyListener mCallState :"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/server/usb/UsbPantechDevice;->mCallState:I
    ...
    .line 132
    .local v3, "shutdownAction":Ljava/lang/String;
    if-eqz v3, :cond_4
    ...
    .line 137
    :cond_4
    iget-boolean v5, p0, Lcom/android/server/usb/UsbPantechDevice;->mBlockPopup:Z
    ...
    const-string v5, "runUsbSettingsActivity"
    ...
    const-string v6, "runUsbSettingsActivity Exception "
