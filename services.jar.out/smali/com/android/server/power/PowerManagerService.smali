...
.field private static final DEVICE_COLOR_BLACK:I = 0x2

.field private static final DEVICE_COLOR_WHITE:I = 0x1
...
.field private static final TOUCH_IOCTL_INIT:I = 0xbb9

.field private static final TOUCH_IOCTL_RESUME:I = 0x1773

.field private static final TOUCH_IOCTL_SUSPEND:I = 0x1772
...
.field static mDebugInit:Z

.field private static mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;

.field private static mSleepReason:I
...
.field private mButtonLightBrightness:I

.field private mContext:Landroid/content/Context;

.field private mCurrentButtonState:Z
...
.field private msky_ctrl_drv:Lcom/pantech/test/Sky_ctrl_drv;
...
.method static constructor <clinit>()V
    ...
    .line 406
    sput-boolean v1, Lcom/android/server/power/PowerManagerService;->mDebugInit:Z

    .line 443
    sput v1, Lcom/android/server/power/PowerManagerService;->mSleepReason:I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/power/PowerManagerService;->msky_ctrl_drv:Lcom/pantech/test/Sky_ctrl_drv;
...
.method static synthetic access$1100(Lcom/android/server/power/PowerManagerService;JI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
    .param p3, "x2"    # I
...
.method static synthetic access$1200(Lcom/android/server/power/PowerManagerService;J)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;
    .param p1, "x1"    # J
...
.method static synthetic access$3000(Lcom/android/server/power/PowerManagerService;)Lcom/pantech/test/Sky_ctrl_drv;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/power/PowerManagerService;

    .prologue
    .line 105
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->msky_ctrl_drv:Lcom/pantech/test/Sky_ctrl_drv;

    return-object v0
.end method

.method static synthetic access$3100()Lcom/android/server/display/DisplayManagerService;
    .locals 1

    .prologue
    .line 105
    sget-object v0, Lcom/android/server/power/PowerManagerService;->mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
...
.method static synthetic access$3300(Z)V
    .locals 0
    .param p0, "x0"    # Z
...
.method private checkIfBootAnimationFinished()V
    ...
    const-string v2, "checkIfBootAnimationFinished call postEvent"
    ...
    check-cast v0, Lcom/android/internal/pantech/led/LedManager;

    .line 2131
    .local v0, "ledManager":Lcom/android/internal/pantech/led/LedManager;
    new-instance v1, Lcom/android/internal/pantech/led/LedInfo;

    sget v2, Lcom/android/internal/pantech/led/LedInfo;->APPID_PREVIEW:I
    ...
    invoke-direct {v1, v2, v3, v6}, Lcom/android/internal/pantech/led/LedInfo;-><init>(I[[II)V

    invoke-virtual {v0, v1, v5}, Lcom/android/internal/pantech/led/LedManager;->postEvent(Lcom/android/internal/pantech/led/LedInfo;I)V

    goto :goto_0

    .line 2124
    .end local v0    # "ledManager":Lcom/android/internal/pantech/led/LedManager;
    :catchall_0
    move-exception v1
...
.method private dumpHelp(Ljava/io/PrintWriter;)V
    ...
    .prologue
    .line 2530
    const-string v0, "LogSwitch Help options:"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2531
    const-string v0, "  [--pm] [--ir] [--id] [--pwm] [--all] [--clear] [-help]"

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2532
    const-string v0, "  --pm: Enable PowerManagerService LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2533
    const-string v0, "  --ir: Enable InputReader LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2534
    const-string v0, "  --id: Enable InputDispatcher LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2535
    const-string v0, "  --pwm: Enable PhoneWindowManagerService LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2536
    const-string v0, "  --all: Enable all LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2537
    const-string v0, "  --clear: Disable all LogSwitch."

    invoke-virtual {p1, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 2538
    const-string v0, "  -help: Print this help text."
...
.method goToSleepNoUpdateLocked(JI)Z
    ...
    .line 1247
    :goto_1
    sput p3, Lcom/android/server/power/PowerManagerService;->mSleepReason:I
...
.method public static lowLevelReboot(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v1, Lcom/android/server/power/PowerManagerService;->mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
...
.method private sendLogOnOffIntent(Z)V
    .locals 3
    .param p1, "check"    # Z
    ...
    const-string v1, "com.pantech.intent.action.LOGONOFF_STATUS"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .local v0, "logOnOffIntent":Landroid/content/Intent;
    if-eqz p1, :cond_0
...
.method private sendPendingNotificationsLocked()V
    ...
    const-string v1, "wake up finished"
    ...
    const-string v1, "go to sleep finished"
    ...
    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mSendGoToSleepFinishedNotificationWhenReady:Z
...
.method private setAllLogSwitch(Z)V
    .locals 0
    .param p1, "check"    # Z

    .prologue
    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->changeDebugMode(Z)V

    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->setDispatcherDebug(Z)V

    invoke-virtual {p0, p1}, Lcom/android/server/power/PowerManagerService;->setReaderDebug(Z)V

    invoke-direct {p0, p1}, Lcom/android/server/power/PowerManagerService;->sendLogOnOffIntent(Z)V
...
.method private static native setDispatcherDebugNative(Z)V
.end method

.method private static native setEventDebugNative(Z)V
.end method
...
.method private static native setReaderDebugNative(Z)V
.end method
...
.method private updateSuspendBlockerLocked()V
    ...
    const-string v4, "updateSuspendBlockerLocked: "
    ...
    .restart local v0    # "needDisplaySuspendBlocker":Z
...
.method public changeDebugMode(Z)V
    .locals 1
    .param p1, "check"    # Z

    .prologue
    sput-boolean p1, Lcom/android/server/power/PowerManagerService;->DEBUG:Z

    sput-boolean p1, Lcom/android/server/power/PowerManagerService;->DEBUG_SPEW:Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/DisplayPowerController;->changeDisplayPowerControlMode(Z)V

    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mNotifier:Lcom/android/server/power/Notifier;

    invoke-virtual {v0, p1}, Lcom/android/server/power/Notifier;->changeNotifierMode(Z)V
...
.method public doProximityNegative(Z)V
    .locals 7
    .param p1, "enable"    # Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/power/PowerManagerService;->changeDebugMode(Z)V

    const/4 v4, 0x1

    const-string v13, "PowerManagerService LogSwitch is enable."
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/power/PowerManagerService;->setDispatcherDebug(Z)V

    const/4 v4, 0x1

    const-string v13, "InputDispatcher LogSwitch is enable."
    ...
    invoke-virtual {v0, v13}, Lcom/android/server/power/PowerManagerService;->setReaderDebug(Z)V

    const/4 v4, 0x1

    const-string v13, "InputReader LogSwitch is enable."
    ...
    invoke-direct {v0, v13}, Lcom/android/server/power/PowerManagerService;->sendLogOnOffIntent(Z)V

    const/4 v4, 0x1

    const-string v13, "PhoneWindowManagerService LogSwitch is enable."
    ...
    invoke-direct {v0, v13}, Lcom/android/server/power/PowerManagerService;->setAllLogSwitch(Z)V

    const/4 v4, 0x1

    const-string v13, "All LogSwitch is enable."
    ...
    const-string v13, "All LogSwitch is disable."
    ...
    invoke-direct {v0, v1}, Lcom/android/server/power/PowerManagerService;->dumpHelp(Ljava/io/PrintWriter;)V
    ...
    :cond_a
    const-string v13, "POWER MANAGER (dumpsys power)\n"
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mDirty:I
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mIsPowered:Z
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mPlugType:I
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mBatteryLevel:I
    ...
    const-string v15, "  mBatteryLevelWhenDreamStarted="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mBatteryLevelWhenDreamStarted:I
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mDockState:I
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mStayOn:Z
    ...
    const-string v15, "  mProximityPositive="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mProximityPositive:Z
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mBootCompleted:Z
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mSystemReady:Z
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mWakeLockSummary:I
    ...
    const-string v15, "  mRequestWaitForNegativeProximity="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mRequestWaitForNegativeProximity:Z
    ...
    const-string v15, "  mSandmanScheduled="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mSandmanScheduled:Z
    ...
    iget-wide v15, v0, Lcom/android/server/power/PowerManagerService;->mLastWakeTime:J
    ...
    const-string v15, "  mLastSleepTime="
    ...
    iget-wide v15, v0, Lcom/android/server/power/PowerManagerService;->mLastSleepTime:J
    ...
    const-string v15, "  mSendWakeUpFinishedNotificationWhenReady="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mSendWakeUpFinishedNotificationWhenReady:Z
    ...
    const-string v15, "  mSendGoToSleepFinishedNotificationWhenReady="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mSendGoToSleepFinishedNotificationWhenReady:Z
    ...
    const-string v15, "  mLastUserActivityTime="
    ...
    iget-wide v15, v0, Lcom/android/server/power/PowerManagerService;->mLastUserActivityTime:J
    ...
    const-string v15, "  mLastUserActivityTimeNoChangeLights="
    ...
    iget-wide v15, v0, Lcom/android/server/power/PowerManagerService;->mLastUserActivityTimeNoChangeLights:J
    ...
    const-string v15, "  mDisplayReady="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDisplayReady:Z
    ...
    const-string v15, "  mHoldingWakeLockSuspendBlocker="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mHoldingWakeLockSuspendBlocker:Z
    ...
    const-string v15, "  mHoldingDisplaySuspendBlocker="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mHoldingDisplaySuspendBlocker:Z
    ...
    const-string v13, "Settings and Configuration:"
    ...
    const-string v15, "  mWakeUpWhenPluggedOrUnpluggedConfig="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mWakeUpWhenPluggedOrUnpluggedConfig:Z
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mSuspendWhenScreenOffDueToProximityConfig:Z
    ...
    const-string v15, "  mDreamsSupportedConfig="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsSupportedConfig:Z
    ...
    const-string v15, "  mDreamsEnabledByDefaultConfig="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsEnabledByDefaultConfig:Z
    ...
    const-string v15, "  mDreamsActivatedOnSleepByDefaultConfig="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsActivatedOnSleepByDefaultConfig:Z
    ...
    const-string v15, "  mDreamsActivatedOnDockByDefaultConfig="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsActivatedOnDockByDefaultConfig:Z
    ...
    const-string v15, "  mDreamsEnabledSetting="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsEnabledSetting:Z
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsActivateOnSleepSetting:Z
    ...
    const-string v15, "  mDreamsActivateOnDockSetting="
    ...
    iget-boolean v15, v0, Lcom/android/server/power/PowerManagerService;->mDreamsActivateOnDockSetting:Z
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenOffTimeoutSetting:I
    ...
    const-string v15, "  mMaximumScreenOffTimeoutFromDeviceAdmin="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mMaximumScreenOffTimeoutFromDeviceAdmin:I

    invoke-virtual {v13, v15}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v13

    const-string v15, " (enforced="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mStayOnWhilePluggedInSetting:I
    ...
    const-string v15, "  mScreenBrightnessSetting="
    ...
    const-string v15, "  mScreenAutoBrightnessAdjustmentSetting="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenAutoBrightnessAdjustmentSetting:F
    ...
    const-string v15, "  mScreenBrightnessModeSetting="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessModeSetting:I
    ...
    const-string v15, "  mScreenBrightnessOverrideFromWindowManager="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessOverrideFromWindowManager:I
    ...
    const-string v15, "  mUserActivityTimeoutOverrideFromWindowManager="
    ...
    iget-wide v15, v0, Lcom/android/server/power/PowerManagerService;->mUserActivityTimeoutOverrideFromWindowManager:J
    ...
    const-string v15, "  mTemporaryScreenBrightnessSettingOverride="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mTemporaryScreenBrightnessSettingOverride:I
    ...
    const-string v15, "  mTemporaryScreenAutoBrightnessAdjustmentSettingOverride="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mTemporaryScreenAutoBrightnessAdjustmentSettingOverride:F
    ...
    const-string v15, "  mScreenBrightnessSettingMinimum="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingMinimum:I
    ...
    const-string v15, "  mScreenBrightnessSettingMaximum="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingMaximum:I
    ...
    const-string v15, "  mScreenBrightnessSettingDefault="
    ...
    iget v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenBrightnessSettingDefault:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/power/PowerManagerService;->getScreenOffTimeoutLocked()I
    ...
    const-string v15, "Screen off timeout: "
    ...
    const-string v15, "Screen dim duration: "
    ...
    const-string v15, "Wake Locks: size="
    ...
    const-string v15, "Suspend Blockers: size="
    ...
    iget-object v13, v0, Lcom/android/server/power/PowerManagerService;->mSuspendBlockers:Ljava/util/ArrayList;
    ...
    const-string v15, "Screen On Blocker: "
    ...
    iget-object v15, v0, Lcom/android/server/power/PowerManagerService;->mScreenOnBlocker:Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;
    ...
    const-string v15, "Display Blanker: "
    ...
    iget-object v15, v0, Lcom/android/server/power/PowerManagerService;->mDisplayBlanker:Lcom/android/server/power/PowerManagerService$DisplayBlankerImpl;
    ...
    iget-object v5, v0, Lcom/android/server/power/PowerManagerService;->mDisplayPowerController:Lcom/android/server/power/DisplayPowerController;

    .local v5, "dpc":Lcom/android/server/power/DisplayPowerController;
    move-object/from16 v0, p0

    iget-object v11, v0, Lcom/android/server/power/PowerManagerService;->mWirelessChargerDetector:Lcom/android/server/power/WirelessChargerDetector;

    .local v11, "wcd":Lcom/android/server/power/WirelessChargerDetector;
    monitor-exit v14
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/power/DisplayPowerController;->dump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v11, v0}, Lcom/android/server/power/WirelessChargerDetector;->dump(Ljava/io/PrintWriter;)V

    goto/16 :goto_2
.end method

.method public getDebugInit()Z
    .locals 1

    .prologue
    sget-boolean v0, Lcom/android/server/power/PowerManagerService;->mDebugInit:Z
...
.method public getSleepReason()I
    .locals 1

    .prologue
    sget v0, Lcom/android/server/power/PowerManagerService;->mSleepReason:I
...
.method public handleButtonLight(Z)V
    .locals 2
    .param p1, "on"    # Z
    ...
    iget-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mCurrentButtonState:Z

    if-eq v0, p1, :cond_2

    sget-object v0, Lcom/android/internal/pantech/PantechVendor;->EF56DeviceList:Ljava/util/ArrayList;
    ...
    iget v1, p0, Lcom/android/server/power/PowerManagerService;->mButtonLightBrightness:I
    ...
    iput-boolean v0, p0, Lcom/android/server/power/PowerManagerService;->mCurrentButtonState:Z
...
.method public init(Landroid/content/Context;Lcom/android/server/LightsService;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/BatteryService;Lcom/android/internal/app/IBatteryStats;Lcom/android/internal/app/IAppOpsService;Lcom/android/server/display/DisplayManagerService;)V
    ...
    sput-object p7, Lcom/android/server/power/PowerManagerService;->mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->mHandlerThread:Landroid/os/HandlerThread;
    ...
    sget-object v1, Lcom/android/internal/pantech/PantechVendor;->EF56DeviceList:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Lcom/android/server/power/PowerManagerService;->msky_ctrl_drv:Lcom/pantech/test/Sky_ctrl_drv;

    iget-object v1, p0, Lcom/android/server/power/PowerManagerService;->msky_ctrl_drv:Lcom/pantech/test/Sky_ctrl_drv;

    const/16 v2, 0x1c20

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v3}, Lcom/pantech/test/Sky_ctrl_drv;->Sky_Ctrl_Touch_With_Arg(II)I

    move-result v0

    .local v0, "deviceColor":I
    packed-switch v0, :pswitch_data_0

    const/16 v1, 0x5555

    iput v1, p0, Lcom/android/server/power/PowerManagerService;->mButtonLightBrightness:I

    .end local v0    # "deviceColor":I
    :cond_0
    :goto_0
    ...
    iget-object v3, p0, Lcom/android/server/power/PowerManagerService;->mHandlerThread:Landroid/os/HandlerThread;
    ...
    invoke-static {p0, v1, v2, v3, v4}, Lcom/android/server/power/PowerManagerServiceInjector;->init(Lcom/android/server/power/PowerManagerService;Lcom/android/server/BatteryService;Lcom/android/server/power/DisplayPowerRequest;Ljava/util/ArrayList;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/power/PowerManagerService$DisplayBlankerImpl;->unblankAllDisplays()V

    return-void

    .restart local v0    # "deviceColor":I
    :pswitch_0
    const v1, 0x9439
...
.method public noAnimationForFactoryTest(Z)V
    .locals 3
    .param p1, "enable"    # Z
    ...
    const-string v2, "noAnimationForFactoryTest  : "
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/DisplayPowerController;->setNoAnimationForFactoryTest(Z)Z
...
.method public setButtonLightsOnMode(Z)V
    ...
    iput-boolean v2, p0, Lcom/android/server/power/PowerManagerService;->mCurrentButtonState:Z

    :cond_0
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mButtonLight:Lcom/android/server/LightsService$Light;

    invoke-virtual {v0, p1}, Lcom/android/server/LightsService$Light;->setButtonLightsOnMode(Z)V
...
.method public setDebugInit()V
    .locals 1

    .prologue
    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/power/PowerManagerService;->mDebugInit:Z

    return-void
.end method

.method public setDispatcherDebug(Z)V
    .locals 0
    .param p1, "check"    # Z

    .prologue
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->setDispatcherDebugNative(Z)V
...
.method public setReaderDebug(Z)V
    ...
    .prologue
    invoke-static {p1}, Lcom/android/server/power/PowerManagerService;->setReaderDebugNative(Z)V
...
.method public systemReady(Lcom/android/server/TwilightService;Lcom/android/server/dreams/DreamManagerService;)V
    ...
    sget-object v9, Lcom/android/server/power/PowerManagerService;->mDisplayManagerService:Lcom/android/server/display/DisplayManagerService;
