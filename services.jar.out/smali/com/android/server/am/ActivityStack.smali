...
.field final mResumedActivities:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private final mTempPausingActivities:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private final mTempResumingActivities:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private final mTempTaskIds:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private final mTempVisibleTaskIds:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Landroid/os/Looper;I)V
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mTempVisibleTaskIds:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mTempResumingActivities:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStack;->mTempPausingActivities:Ljava/util/ArrayList;
...
.method private adjustFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/am/ActivityStack;->isTopTaskLocked(I)Z

    move-result v3

    if-eqz v3, :cond_0

    iget-boolean v3, v1, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    .line 3001
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getTopTaskIdLocked()I

    move-result v2

    .line 3002
    .local v2, "topTaskId":I
    iget-object v3, v0, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
...
.method private checkHideDockBarApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)V
    .locals 2
    ...
    .prologue
    .line 4936
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/ActivityStack;->isExceptionApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Z
    ...
    const-string v1, "checkHideDockBarApplication.result = OK"
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wm/WindowManagerService;->setMultiDockBarHide(Z)V
    ...
    const-string v1, "checkHideDockBarApplication.result = NOK"
...
.method private final getMovingTaskIdsToBackLocked(I)Ljava/util/ArrayList;
    .locals 2
    .param p1, "taskId"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 4921
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityManagerService;->mMultiWindowManager:Lcom/pantech/server/multiwindow/MultiWindowManagerService;

    invoke-virtual {v0, p1}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->moveRelatedIdsToBack(I)V
...
.method private final getMovingTaskIdsToFrontLocked(ILcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    .locals 3
    .param p1, "taskId"    # I
    ...
    .line 4908
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lcom/android/server/am/ActivityManagerService;->mMultiWindowManager:Lcom/pantech/server/multiwindow/MultiWindowManagerService;
    ...
    iget-object v0, p3, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;

    :cond_0
    invoke-virtual {v2, p1, v1, v0}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->moveRelatedIdsToFront(ILandroid/content/Intent;Landroid/os/IBinder;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;

    invoke-virtual {v0, p1, v1, v2}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->getRelatedIds(IZLjava/util/ArrayList;)V
...
.method private final getPausingActivitiesLocked()Ljava/util/ArrayList;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 4896
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mTempPausingActivities:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->clear()V

    .line 4898
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/am/ActivityStack;->mTempResumingActivities:Ljava/util/ArrayList;
...
.method private final getResumingActivitiesLocked(Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    .locals 7
    .param p1, "next"    # Lcom/android/server/am/ActivityRecord;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 4878
    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->mTempResumingActivities:Ljava/util/ArrayList;

    invoke-virtual {v3}, Ljava/util/ArrayList;->clear()V

    .line 4879
    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;
    ...
    iget-object v3, v3, Lcom/android/server/am/ActivityManagerService;->mMultiWindowManager:Lcom/pantech/server/multiwindow/MultiWindowManagerService;
    ...
    iget-object v6, p0, Lcom/android/server/am/ActivityStack;->mTempTaskIds:Ljava/util/ArrayList;

    invoke-virtual {v3, v4, v5, v6}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->getRelatedIds(IZLjava/util/ArrayList;)V
    ...
    .line 4883
    .local v1, "tempTaskId":I
    invoke-direct {p0, v1}, Lcom/android/server/am/ActivityStack;->topRunningActivityWithTaskIdLocked(I)Lcom/android/server/am/ActivityRecord;
...
.method private final getTopTaskIdLocked()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->getTopId()I
...
.method private final getVisibleTaskIdsLocked()Ljava/util/ArrayList;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 4856
    iget-object v4, p0, Lcom/android/server/am/ActivityStack;->mTempVisibleTaskIds:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/am/ActivityStack;->mTempVisibleTaskIds:Ljava/util/ArrayList;

    invoke-virtual {v4, v5}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->getVisibleIds(Ljava/util/ArrayList;)V
    ...
    .line 4867
    .local v2, "taskId":I
    invoke-virtual {p0, v2}, Lcom/android/server/am/ActivityStack;->taskForIdLocked(I)Lcom/android/server/am/TaskRecord;
...
.method private insertTaskAtTop(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 2350
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/server/am/ActivityStack;->removeTask(Lcom/android/server/am/TaskRecord;)Z
...
.method private isExceptionApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)Z
    .locals 4
    .param p1, "PackageName"    # Ljava/lang/String;
    ...
    iget-boolean v1, p2, Landroid/content/pm/ApplicationInfo;->hidemultiwindowdockbar:Z
    ...
    const-string v3, " is hide dockbar package"
...
.method private final isFullscreenActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    .locals 3
    .param p1, "r"    # Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v1, v1, Lcom/android/server/am/ActivityManagerService;->mMultiWindowManager:Lcom/pantech/server/multiwindow/MultiWindowManagerService;

    iget-object v2, p1, Lcom/android/server/am/ActivityRecord;->appToken:Landroid/view/IApplicationToken$Stub;

    invoke-virtual {v1, v2}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->getZone(Landroid/os/IBinder;)I
...
.method private isTopTaskLocked(I)Z
    .locals 4
    .param p1, "taskId"    # I
...
.method private final makeFinishingActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    .locals 2
    .param p1, "r"    # Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v0, v1}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->makeFinishing(Landroid/os/IBinder;)V
...
.method private final removeActivityFromHistoryLockedInner(Lcom/android/server/am/ActivityRecord;)V
    .locals 2
    .param p1, "r"    # Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v0, v1}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->remove(Landroid/os/IBinder;)V
...
.method private final resumeTopActivityLockedInner(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Z)Z
    .locals 36
    .param p1, "next"    # Lcom/android/server/am/ActivityRecord;
    .param p2, "prev"    # Lcom/android/server/am/ActivityRecord;
    .param p3, "options"    # Landroid/os/Bundle;
    .param p4, "userLeaving"    # Z
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
    ...
    .line 1917
    .local v23, "exists":Z
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->getPausingActivitiesLocked()Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/am/ActivityStack;->startPausingLockedInner(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    .line 1922
    .end local v18    # "activity":Lcom/android/server/am/ActivityRecord;
    :cond_0
    if-nez v23, :cond_2
    ...
    iget-boolean v3, v0, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    .restart local v31    # "numActivities":I
    ...
    iput-boolean v4, v3, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->pauseBackStacks(Z)Z
    ...
    iget-object v5, v0, Lcom/android/server/am/ActivityStack;->mPausingActivities:Ljava/util/ArrayList;
    ...
    .line 2047
    .restart local v18    # "activity":Lcom/android/server/am/ActivityRecord;
    const/4 v3, 0x0
    ...
    .line 2164
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/am/ActivityRecord;->applyOptionsLocked()V
    ...
    .line 2170
    .local v26, "lastStack":Lcom/android/server/am/ActivityStack;
    move-object/from16 v0, p1
    ...
    .line 2181
    .local v25, "lastResumedActivity":Lcom/android/server/am/ActivityRecord;
    :goto_c
    move-object/from16 v0, p1
    ...
    .line 2183
    .local v27, "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    move-object/from16 v0, p0
    ...
    .line 2193
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/am/ActivityStack;->updateLRUListLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .end local v25    # "lastResumedActivity":Lcom/android/server/am/ActivityRecord;
    .end local v26    # "lastStack":Lcom/android/server/am/ActivityStack;
    .end local v27    # "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    .line 2166
    :cond_1d
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/am/ActivityRecord;->clearOptionsLocked()V

    goto/16 :goto_b

    .line 2179
    .restart local v26    # "lastStack":Lcom/android/server/am/ActivityStack;
    :cond_1e
    ...
    .line 2200
    .restart local v25    # "lastResumedActivity":Lcom/android/server/am/ActivityRecord;
    .restart local v27    # "lastState":Lcom/android/server/am/ActivityStack$ActivityState;
    ...
    invoke-interface {v3, v4, v5, v6}, Landroid/app/IApplicationThread;->scheduleResumeActivity(Landroid/os/IBinder;IZ)V
...
.method private final startActivityLockedInner(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Z)V
    .locals 11
    .param p1, "r"    # Lcom/android/server/am/ActivityRecord;
    ...
    :goto_0
    invoke-virtual/range {v0 .. v6}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->add(Landroid/os/IBinder;ILandroid/content/Intent;ZZLandroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->setMultiple(IZ)V
    ...
    iget-boolean v0, v9, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    invoke-virtual {v0, v1}, Lcom/pantech/server/multiwindow/MultiWindowManagerService;->moveIdToFront(I)V
...
.method private final startPausingLockedInner(Lcom/android/server/am/ActivityRecord;ZZ)V
    .locals 8
    .param p1, "prev"    # Lcom/android/server/am/ActivityRecord;
    ...
    .line 875
    iget-object v3, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1, v3, v4}, Lcom/android/server/am/ActivityRecord;->updateThumbnail(Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, p1, v5}, Lcom/android/server/am/ActivityManagerService;->updateUsageStats(Lcom/android/server/am/ActivityRecord;Z)V
    ...
    invoke-interface {v3, v5, v6, p2, v7}, Landroid/app/IApplicationThread;->schedulePauseActivity(Landroid/os/IBinder;ZZI)V
    :try_end_0
...
.method private final topRunningActivityWithTaskIdLocked(I)Lcom/android/server/am/ActivityRecord;
    .locals 2
    .param p1, "taskId"    # I
...
.method final activityPausedLocked(Landroid/os/IBinder;Z)V
    ...
    .line 961
    iget-object v1, p0, Lcom/android/server/am/ActivityStack;->mPausingActivities:Ljava/util/ArrayList;
...
.method final activityStoppedLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Landroid/graphics/Bitmap;Ljava/lang/CharSequence;)V
    ...
    .line 1004
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->isFullscreenActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/server/am/ActivityStack;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    invoke-virtual {p0, p1, v3, v2, v0}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
...
.method final destroyActivitiesLocked(Lcom/android/server/am/ProcessRecord;ZLjava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZ)Z
    ...
    .line 1242
    .local v11, "visibleTaskIds":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    if-nez v4, :cond_3

    .line 1243
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->getVisibleTaskIdsLocked()Ljava/util/ArrayList;
    ...
    .end local v11    # "visibleTaskIds":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :cond_6
    const/4 v4, 0x0
    ...
    .restart local v11    # "visibleTaskIds":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :cond_7
    const/4 v4, 0x0
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;Ljava/lang/String;ZZ)Z
    ...
    .line 3204
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->makeFinishingActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, p1, v6, v7}, Lcom/android/server/am/ActivityStack;->startPausingLockedInner(Lcom/android/server/am/ActivityRecord;ZZ)V
...
.method getDetailTasksLocked(Ljava/util/List;)Lcom/android/server/am/ActivityRecord;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .line 4566
    .local p1, "list":Ljava/util/List;, "Ljava/util/List<Landroid/app/ActivityManager$RunningTaskDetailInfo;>;"
    const/4 v9, 0x0
    ...
    .line 4593
    :cond_2
    new-instance v2, Landroid/app/ActivityManager$RunningTaskDetailInfo;

    invoke-direct {v2}, Landroid/app/ActivityManager$RunningTaskDetailInfo;-><init>()V

    .line 4594
    .local v2, "ci":Landroid/app/ActivityManager$RunningTaskDetailInfo;
    iget v10, v6, Lcom/android/server/am/TaskRecord;->taskId:I

    iput v10, v2, Landroid/app/ActivityManager$RunningTaskDetailInfo;->id:I

    .line 4595
    iget-object v10, v5, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;

    iput-object v10, v2, Landroid/app/ActivityManager$RunningTaskDetailInfo;->realActivity:Landroid/content/ComponentName;
    ...
    iput-object v10, v2, Landroid/app/ActivityManager$RunningTaskDetailInfo;->description:Ljava/lang/CharSequence;
    ...
    .line 4567
    .end local v2    # "ci":Landroid/app/ActivityManager$RunningTaskDetailInfo;
    :cond_4
    add-int/lit8 v7, v7, -0x1
...
.method minimalResumeActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 620
    iget-object v0, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
...
.method moveHomeTaskToTop()V
    ...
    invoke-direct {p0, v3, v4, v4}, Lcom/android/server/am/ActivityStack;->getMovingTaskIdsToFrontLocked(ILcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v22, "moveTaskToBack: "
    ...
    invoke-interface/range {v20 .. v21}, Landroid/app/IActivityController;->activityResuming(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/server/Watchdog;->setActivityController(Landroid/app/IActivityController;)V
    ...
    .line 4084
    .local v17, "taskIds":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    const/4 v10, 0x0

    .line 4089
    .local v10, "numTaskIds":I
    const/4 v5, 0x0

    .line 4094
    .local v5, "isTopTask":Z
    invoke-direct/range {p0 .. p1}, Lcom/android/server/am/ActivityStack;->getMovingTaskIdsToBackLocked(I)Ljava/util/ArrayList;
    ...
    .line 4098
    invoke-direct/range {p0 .. p1}, Lcom/android/server/am/ActivityStack;->isTopTaskLocked(I)Z
    ...
    invoke-virtual {v0, v15}, Lcom/android/server/am/ActivityStack;->removeTask(Lcom/android/server/am/TaskRecord;)Z
    ...
    .end local v15    # "task":Lcom/android/server/am/TaskRecord;
    .end local v16    # "taskIdNdx":I
    :cond_7
    move-object/from16 v0, p0

    move-object/from16 v1, v19

    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->removeTask(Lcom/android/server/am/TaskRecord;)Z
    ...
    .line 4158
    .restart local v15    # "task":Lcom/android/server/am/TaskRecord;
    iget-boolean v0, v15, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    invoke-virtual/range {v20 .. v22}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;
    ...
    .line 4209
    .local v14, "resumedActivity":Lcom/android/server/am/ActivityRecord;
    iget-object v15, v14, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    .end local v14    # "resumedActivity":Lcom/android/server/am/ActivityRecord;
    .end local v15    # "task":Lcom/android/server/am/TaskRecord;
    :cond_10
    move-object/from16 v0, p0
    ...
    .line 4220
    .restart local v14    # "resumedActivity":Lcom/android/server/am/ActivityRecord;
    iget-object v15, v14, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    .line 4214
    .restart local v4    # "i$":Ljava/util/Iterator;
    .restart local v13    # "resumeHome":Z
    .restart local v14    # "resumedActivity":Lcom/android/server/am/ActivityRecord;
    .restart local v15    # "task":Lcom/android/server/am/TaskRecord;
    :cond_13
    iget-boolean v0, v15, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    invoke-virtual/range {v20 .. v21}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/am/ActivityStackSupervisor;->resumeTopActivitiesLocked()Z
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Lcom/android/server/am/ActivityRecord;)V

    .line 4033
    return-void
.end method

.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Lcom/android/server/am/ActivityRecord;)V
    .locals 13
    .param p1, "tr"    # Lcom/android/server/am/TaskRecord;
    .param p2, "reason"    # Lcom/android/server/am/ActivityRecord;
    .param p3, "options"    # Landroid/os/Bundle;
    ...
    .line 3968
    .local v2, "numTaskIds":I
    iget v9, p1, Lcom/android/server/am/TaskRecord;->taskId:I

    move-object/from16 v0, p4

    invoke-direct {p0, v9, p2, v0}, Lcom/android/server/am/ActivityStack;->getMovingTaskIdsToFrontLocked(ILcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/am/ActivityStack;->taskForIdLocked(I)Lcom/android/server/am/TaskRecord;
    ...
    .line 3974
    invoke-direct {p0, v5}, Lcom/android/server/am/ActivityStack;->insertTaskAtTop(Lcom/android/server/am/TaskRecord;)V
    ...
    iput-boolean v9, v5, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    invoke-virtual {v10, v9}, Lcom/android/server/wm/WindowManagerService;->moveTaskToTop(I)V
...
.method final removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 3577
    invoke-direct {p0, p1}, Lcom/android/server/am/ActivityStack;->removeActivityFromHistoryLockedInner(Lcom/android/server/am/ActivityRecord;)V
...
.method removeHistoryRecordsForAppLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    .line 3805
    iget-object v7, p0, Lcom/android/server/am/ActivityStack;->mPausingActivities:Ljava/util/ArrayList;

    const-string v8, "mPausingActivities"

    invoke-direct {p0, v7, p1, v8}, Lcom/android/server/am/ActivityStack;->removeHistoryRecordsForAppLocked(Ljava/util/ArrayList;Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V

    .line 3806
    iget-object v7, p0, Lcom/android/server/am/ActivityStack;->mResumedActivities:Ljava/util/ArrayList;

    const-string v8, "mResumedActivities"
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    iget-boolean v6, v7, Lcom/android/server/am/ActivityStackSupervisor;->mUserLeaving:Z

    .line 1454
    .local v6, "userLeaving":Z
    iget-object v7, p0, Lcom/android/server/am/ActivityStack;->mStackSupervisor:Lcom/android/server/am/ActivityStackSupervisor;

    iput-boolean v8, v7, Lcom/android/server/am/ActivityStackSupervisor;->mUserLeaving:Z
    ...
    invoke-virtual {v7, p1}, Lcom/android/server/am/ActivityStackSupervisor;->resumeHomeActivity(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 1467
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/server/am/ActivityStack;->getResumingActivitiesLocked(Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    ...
    iget-boolean v7, v4, Lcom/android/server/am/TaskRecord;->mOnTopOfHome:Z
    ...
    .line 1475
    iput-boolean v8, v3, Lcom/android/server/am/ActivityRecord;->delayedResume:Z
    ...
    invoke-direct {p0, v1, p1, p2, v6}, Lcom/android/server/am/ActivityStack;->resumeTopActivityLockedInner(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;Z)Z
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityStackSupervisor;->allResumedActivitiesComplete()Z
    ...
    invoke-virtual {v7, v3}, Lcom/android/server/am/ActivityManagerService;->setFocusedActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-direct {p0, v7, v8}, Lcom/android/server/am/ActivityStack;->checkHideDockBarApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;)V
...
.method final startActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    .locals 25
    .param p1, "r"    # Lcom/android/server/am/ActivityRecord;
    .param p2, "sourceRecord"    # Lcom/android/server/am/ActivityRecord;
    .param p3, "newTask"    # Z
    .param p4, "doResume"    # Z
    .param p5, "keepCurTransition"    # Z
    ...
    invoke-direct {v0, v1, v3, v4}, Lcom/android/server/am/ActivityStack;->getMovingTaskIdsToFrontLocked(ILcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/android/server/am/ActivityStack;->startActivityLockedInner(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Z)V

    .line 2420
    invoke-static/range {p6 .. p6}, Landroid/app/ActivityOptions;->abort(Landroid/os/Bundle;)V
    ...
    .line 2522
    .local v20, "resumedActivity":Lcom/android/server/am/ActivityRecord;
    move-object/from16 v0, v20
    ...
    .line 2541
    .end local v20    # "resumedActivity":Lcom/android/server/am/ActivityRecord;
    :cond_f
    move-object/from16 v0, p0
...
.method final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/am/ActivityStack;->startActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
...
.method final startPausingLocked(ZZ)V
    ...
    .line 780
    .local v1, "resumedActivity":Lcom/android/server/am/ActivityRecord;
    invoke-direct {p0, v1, p1, p2}, Lcom/android/server/am/ActivityStack;->startPausingLockedInner(Lcom/android/server/am/ActivityRecord;ZZ)V
...
.method final stopActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-interface {v0, v1, v4, v5}, Landroid/app/IApplicationThread;->scheduleStopActivity(Landroid/os/IBinder;ZI)V
    ...
    .line 3062
    invoke-virtual {p0, v3, v2}, Lcom/android/server/am/ActivityStack;->ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;I)Z
