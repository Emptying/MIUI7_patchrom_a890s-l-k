...
# instance fields
.field private isWiFiSM:Z

.field private mDbg:Z

.field private mDbg_Msg:Z
...
.method private constructor <init>(Landroid/os/Looper;Lcom/android/internal/util/StateMachine;)V
    ...
    .line 686
    iput-boolean v0, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mDbg_Msg:Z

    .line 687
    iput-boolean v0, p0, Lcom/android/internal/util/StateMachine$SmHandler;->isWiFiSM:Z
...
.method static synthetic access$1100(Lcom/android/internal/util/StateMachine$SmHandler;)Landroid/os/Message;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/util/StateMachine$SmHandler;
...
.method static synthetic access$2700(Lcom/android/internal/util/StateMachine$SmHandler;Ljava/util/HashMap;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/util/StateMachine$SmHandler;
    ...
    .prologue
    .line 677
    invoke-direct {p0, p1}, Lcom/android/internal/util/StateMachine$SmHandler;->setWiFiDbgMsg(Ljava/util/HashMap;)V
...
.method static synthetic access$2800(Lcom/android/internal/util/StateMachine$SmHandler;)V
    ...
    .prologue
    .line 677
    invoke-direct {p0}, Lcom/android/internal/util/StateMachine$SmHandler;->enableWiFiDbgMsg()V

    return-void
.end method

.method static synthetic access$2900(Lcom/android/internal/util/StateMachine$SmHandler;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/util/StateMachine$SmHandler;
...
.method private final enableWiFiDbgMsg()V
    .locals 1
...
.method private final setWiFiDbgMsg(Ljava/util/HashMap;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1246
    # setter for: Lcom/android/internal/util/StateMachine;->mMsgStr:Ljava/util/HashMap;
    invoke-static {p1}, Lcom/android/internal/util/StateMachine;->access$702(Ljava/util/HashMap;)Ljava/util/HashMap;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    .prologue
    .line 788
    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mHasQuit:Z
    ...
    .line 792
    .local v0, "curStateInfo":Lcom/android/internal/util/StateMachine$SmHandler$StateInfo;
    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mDbg_Msg:Z

    if-eqz v2, :cond_2

    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->isWiFiSM:Z
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/internal/util/StateMachine;->log_str(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    .line 804
    .local v1, "msgProcessedState":Lcom/android/internal/util/State;
    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mIsConstructionCompleted:Z
    ...
    .line 816
    :goto_1
    invoke-direct {p0, v1, p1}, Lcom/android/internal/util/StateMachine$SmHandler;->performTransitions(Lcom/android/internal/util/State;Landroid/os/Message;)V
    ...
    .line 821
    .end local v0    # "curStateInfo":Lcom/android/internal/util/StateMachine$SmHandler$StateInfo;
    .end local v1    # "msgProcessedState":Lcom/android/internal/util/State;
    :cond_1
    return-void

    .line 794
    .restart local v0    # "curStateInfo":Lcom/android/internal/util/StateMachine$SmHandler$StateInfo;
    :cond_2
    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mDbg:Z
    ...
    .line 807
    .restart local v1    # "msgProcessedState":Lcom/android/internal/util/State;
    :cond_3
    iget-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mIsConstructionCompleted:Z
    ...
    iput-boolean v2, p0, Lcom/android/internal/util/StateMachine$SmHandler;->mIsConstructionCompleted:Z
    ...
    const-string v4, "StateMachine.handleMessage: The start method not called, received msg: "
