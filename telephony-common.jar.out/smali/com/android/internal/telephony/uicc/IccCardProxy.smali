...
.field private static final EVENT_ICC_IO_ERROR:I = 0xd
...
.field private mSimLockedRegistrants:Landroid/os/RegistrantList;
...
.field private skipUpdateExternalState:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    .line 109
    iput-boolean v1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->skipUpdateExternalState:Z
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mSimLockedRegistrants:Landroid/os/RegistrantList;
...
.method private getPersoLockedReason(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;)Ljava/lang/String;
    .locals 3
...
.method protected broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "QuietMode: NOT Broadcasting intent ACTION_SIM_STATE_CHANGED "
    ...
    const-string v6, "Broadcasting READY type is "
    ...
    const-string v6, "Broadcasting intent ACTION_SIM_STATE_CHANGED "
    ...
    invoke-static {v1, v4, v6}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
...
.method protected getIccStateReason(Lcom/android/internal/telephony/IccCardConstants$State;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->getPersoLockedReason(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;)Ljava/lang/String;
...
.method public registerForSimLocked(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 2
    .param p1, "h"    # Landroid/os/Handler;
    .param p2, "what"    # I
    .param p3, "obj"    # Ljava/lang/Object;
    ...
    .line 692
    .local v0, "r":Landroid/os/Registrant;
    iget-object v1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mSimLockedRegistrants:Landroid/os/RegistrantList;
...
.method protected registerUiccCardEvents()V
    ...
    invoke-virtual {v0, p0, v1, v2}, Lcom/android/internal/telephony/uicc/UiccCard;->registerForIoError(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public unregisterForSimLocked(Landroid/os/Handler;)V
    .locals 1
    .param p1, "h"    # Landroid/os/Handler;

    .prologue
    .line 703
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mSimLockedRegistrants:Landroid/os/RegistrantList;
...
.method protected unregisterUiccCardEvents()V
    ...
    invoke-virtual {v0, p0}, Lcom/android/internal/telephony/uicc/UiccCard;->unregisterForIoError(Landroid/os/Handler;)V
...
.method protected updateExternalState()V
    ...
    .line 384
    :cond_2
    iget-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->skipUpdateExternalState:Z
    ...
    const-string v3, "Refresh mode on. check card state = "
    ...
    .line 390
    const-string v2, "Refresh mode on. Skip setExternalState"
    ...
    invoke-virtual {v2, v4}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->setAppRefreshInitEnabled(Z)V

    .line 396
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->skipUpdateExternalState:Z
    ...
    const-string v3, "updateExternalState(). cardType is "
    ...
    const-string v3, ". So, Not set & broadcast CARD_IO_ERROR."
...
.method protected updateIccAvailability()V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getAppRefreshInitEnabled()Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->skipUpdateExternalState:Z
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/uicc/UiccController;->getDefaultIccCard()Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    invoke-virtual {v3, p0, v5, v6}, Lcom/android/internal/telephony/uicc/UiccCard;->registerForAbsent(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-virtual {v3, p0, v5, v6}, Lcom/android/internal/telephony/uicc/UiccCard;->registerForIoError(Landroid/os/Handler;ILjava/lang/Object;)V
