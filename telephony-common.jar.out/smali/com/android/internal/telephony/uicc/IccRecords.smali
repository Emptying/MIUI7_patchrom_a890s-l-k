...
.method private handleRefresh(Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
    ...
    .line 460
    const-string v7, "handleRefresh received without input"
    ...
    .line 465
    :cond_1
    iget-object v7, p1, Lcom/android/internal/telephony/uicc/IccRefreshResponse;->aid:Ljava/lang/String;
    ...
    const-string v8, "[REFRESH] Rsp\'s aid_len="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p1, Lcom/android/internal/telephony/uicc/IccRefreshResponse;->aid:Ljava/lang/String;
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/uicc/IccRecords;->loge(Ljava/lang/String;)V

    .line 466
    :cond_2
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mParentApp:Lcom/android/internal/telephony/uicc/UiccCardApplication;

    invoke-virtual {v7}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getAid()Ljava/lang/String;
    ...
    const-string v8, "[REFRESH] ParentApp\'s aid_len="

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mParentApp:Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    .line 554
    const-string v7, "handleRefresh with unknown operation"
    ...
    .line 483
    :pswitch_0
    const-string v7, "handleRefresh with SIM_FILE_UPDATED"

    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/uicc/IccRecords;->log(Ljava/lang/String;)V

    .line 484
    iget v7, p1, Lcom/android/internal/telephony/uicc/IccRefreshResponse;->efId:I

    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/uicc/IccRecords;->handleFileUpdate(I)V

    goto/16 :goto_0

    .line 487
    :pswitch_1
    const-string v7, "handleRefresh with SIM_REFRESH_INIT"

    invoke-virtual {p0, v7}, Lcom/android/internal/telephony/uicc/IccRecords;->log(Ljava/lang/String;)V

    .line 489
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mAdnCache:Lcom/android/internal/telephony/uicc/AdnRecordCache;
    ...
    invoke-virtual {v7, v9}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->setAppRefreshInitEnabled(Z)V

    goto/16 :goto_0

    .line 497
    :pswitch_2
    const-string v7, "handleRefresh with SIM_REFRESH_RESET"
    ...
    .line 499
    iget-object v7, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v8, 0x0

    invoke-interface {v7, v10, v8}, Lcom/android/internal/telephony/CommandsInterface;->setRadioPower(ZLandroid/os/Message;)V
    ...
    .line 521
    .local v4, "otaNotificationManager":Landroid/app/NotificationManager;
    new-instance v3, Landroid/app/Notification;

    invoke-direct {v3}, Landroid/app/Notification;-><init>()V

    .line 522
    .local v3, "otaNotification":Landroid/app/Notification;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v4, "android.sky.intent.action.KT_SUBS_SIM_REFRESH"
    ...
    const-string v5, "EVENT_SIM_REFRESH => ACTION_KT_SUBS_SIM_REFRESH"

    invoke-static {v4, v5}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 447
    iget-object v4, p0, Lcom/android/internal/telephony/uicc/IccRecords;->mContext:Landroid/content/Context;
