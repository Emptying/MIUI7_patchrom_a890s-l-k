...
.field public static simCardType:I
...
.field mSEN:Lcom/android/internal/telephony/gsm/SkyEventNotifier;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/internal/telephony/gsm/GSMPhone;->simCardType:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;Z)V
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->runnng_usim_dn:Z

    iput-boolean v7, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->only_home_key:Z

    iput-boolean v7, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mTimeValidCheck:Z
...
.method public getOnlyHomeKey()Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->only_home_key:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :goto_0
    :sswitch_0
    invoke-virtual/range {p0 .. p1}, Lcom/android/internal/telephony/gsm/GSMPhone;->checkAndNotifyDeviceId(Landroid/os/Message;)V
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSkyTelephonyIM()Lcom/android/internal/telephony/gsm/SkyTelephonyInterfaceManager;
    ...
    invoke-virtual/range {v31 .. v33}, Lcom/android/internal/telephony/gsm/SkyTelephonyInterfaceManager;->getQcNvRead_int(II)I
    :try_end_0
    ...
    const-string v32, "gcf_test_mode"
    ...
    const-string v32, "Settings.System.GCF_TEST_MODE write Success!!"
    ...
    const-string v32, "Settings.System.GCF_TEST_MODE write FAIL!!"
    ...
    const-string v32, "NV_GPRS_ANITE_GCF_I : access Error"
    ...
    const-string v31, "EVENT_REGISTERED_TO_NETWORK received !!"
    ...
    const-string v32, "[TIME_SET] EVENT_REGISTERED_TO_NETWORK, sendMessages"

    invoke-static/range {v31 .. v32}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    const/16 v31, 0x12c

    const-wide/16 v32, 0x2328
    ...
    const-string v32, "00000000000000"
    ...
    const-string v31, "android.internal.telephony.sky.intent.action.TIME_VALIDITY_CHECK"
    ...
    :cond_4
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GSMPhone;->getIccFileHandler()Lcom/android/internal/telephony/uicc/IccFileHandler;
    ...
    invoke-virtual/range {v31 .. v33}, Lcom/android/internal/telephony/uicc/IccFileHandler;->loadEFTransparent(ILandroid/os/Message;)V
    ...
    :cond_5
    invoke-static/range {v21 .. v22}, Lcom/android/internal/telephony/SkyUtils;->getMinNumber(II)Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/gsm/GSMPhone;->mImsi_m:Ljava/lang/String;

    goto/16 :goto_0

    .end local v5    # "ar":Landroid/os/AsyncResult;
    .end local v15    # "imsi_m":[B
    .end local v21    # "min1":I
    .end local v22    # "min2":I
    :sswitch_7
    move-object/from16 v0, p1
    ...
    .local v18, "irm_min1":I
    const/16 v19, 0x0

    .local v19, "irm_min2":I
    ...
    :cond_6
    invoke-static/range {v18 .. v19}, Lcom/android/internal/telephony/SkyUtils;->getMinNumber(II)Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/android/internal/telephony/gsm/GSMPhone;->mIrm:Ljava/lang/String;

    goto/16 :goto_0

    .end local v5    # "ar":Landroid/os/AsyncResult;
    .end local v17    # "irm":[B
    .end local v18    # "irm_min1":I
    .end local v19    # "irm_min2":I
    :sswitch_8
    move-object/from16 v0, p1
    ...
    .local v28, "ussdMsg":Ljava/lang/String;
    move-object/from16 v0, v30
    ...
    .end local v28    # "ussdMsg":Ljava/lang/String;
    .local v29, "ussdMsg":Ljava/lang/String;
    move-object/from16 v28, v29

    .end local v29    # "ussdMsg":Ljava/lang/String;
    .restart local v28    # "ussdMsg":Ljava/lang/String;
    goto :goto_2
    ...
    const-string v32, "error USSD msg CharSet exchange."
    ...
    check-cast v24, Lcom/android/internal/telephony/gsm/SuppServiceNotification;

    .local v24, "not":Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    move-object/from16 v0, p0
    ...
    .end local v5    # "ar":Landroid/os/AsyncResult;
    .end local v24    # "not":Lcom/android/internal/telephony/gsm/SuppServiceNotification;
    :sswitch_e
    move-object/from16 v0, p1
    ...
    iget-object v8, v5, Landroid/os/AsyncResult;->userObj:Ljava/lang/Object;

    check-cast v8, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;
    ...
    :goto_4
    iget-object v0, v8, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;->mSetCfNumber:Ljava/lang/String;
    ...
    :cond_c
    iget-object v0, v8, Lcom/android/internal/telephony/gsm/GSMPhone$Cfu;->mOnComplete:Landroid/os/Message;
    ...
    const-string v32, "Stop duplicate SET_NETWORK_SELECTION_AUTOMATIC to Ril "
    ...
    const-string v32, "Event EVENT_SS received"
    ...
    check-cast v31, Lcom/android/internal/telephony/uicc/UiccCardApplication;
    ...
    const-string v33, "Callforwarding is "
    ...
    const-string v33, "Error set perso feature data with exception "
    ...
    const-string v33, "Error get perso indicator with exception "
    ...
    const-string v33, "Error change perso indicator with exception "
...
.method protected onUpdateIccAvailability()V
    ...
    :cond_0
    iget-object v6, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mMiuiIccPhoneBookInterfaceManager:Lcom/android/internal/telephony/MiuiIccPhoneBookInterfaceManager;

    if-eqz v6, :cond_miui_0

    iget-object v6, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mMiuiIccPhoneBookInterfaceManager:Lcom/android/internal/telephony/MiuiIccPhoneBookInterfaceManager;

    iget-object v7, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;
    ...
    invoke-virtual {v6, v7}, Lcom/android/internal/telephony/MiuiIccPhoneBookInterfaceManager;->setIccCard(Lcom/android/internal/telephony/uicc/UiccCard;)V
...
.method public setOnlyHomeKey(Z)V
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->only_home_key:Z
...
.method protected setProperties()V
    ...
    new-instance v0, Lcom/android/internal/telephony/gsm/SkyEventNotifier;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/gsm/SkyEventNotifier;-><init>(Lcom/android/internal/telephony/Phone;)V

    iput-object v0, p0, Lcom/android/internal/telephony/gsm/GSMPhone;->mSEN:Lcom/android/internal/telephony/gsm/SkyEventNotifier;
