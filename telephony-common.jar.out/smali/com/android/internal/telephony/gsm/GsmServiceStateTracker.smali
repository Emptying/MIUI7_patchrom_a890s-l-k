...
.field private static broadcast_check_time:Z

.field private static broadcast_check_time_zone:Z
...
.method static constructor <clinit>()V
    ...
    .line 109
    sput-boolean v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->broadcast_check_time_zone:Z

    .line 110
    sput-boolean v0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->broadcast_check_time:Z
...
.method private TimeZoneFix(ILjava/lang/String;)Ljava/util/TimeZone;
    .locals 3
    .param p1, "tzOffset"    # I
    ...
    .line 2335
    .local v0, "tzoffset":I
    iget-boolean v2, p0, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->mGotCountryCode:Z
...
.method private isRoamingCompensation(ZLandroid/telephony/ServiceState;)Z
    .locals 6
    .param p1, "Roaming"    # Z
    ...
    .line 2355
    .local v0, "getOPNumeric":Ljava/lang/String;
    ...
    const-string v3, "@@@ Compensation Roaming Indicator: In Korea, But Roaming ON!!!"
    ...
    const-string v3, "@@@ Compensation Roaming Indicator: Not in Korea, But Roaming OFF!!!"
...
.method private pollState()V
    ...
    invoke-virtual {v0, v2}, Landroid/telephony/ServiceState;->setDataRegState(I)V
    ...
    invoke-virtual {v0, v3}, Landroid/telephony/ServiceState;->setRilDataRadioTechnology(I)V
...
.method private pollStateDone()V
    ...
    invoke-virtual/range {v38 .. v38}, Landroid/telephony/ServiceState;->getSubState()I

    move-result v38

    invoke-virtual/range {v37 .. v38}, Landroid/telephony/ServiceState;->setSubState(I)V
    ...
    const-string v38, "gsm.operator.sky_numeric"
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->logt(Ljava/lang/String;)V
    ...
    const-string v38, "TimeZone(NeedFixZone) Saved : "
    ...
    .line 1302
    const-string v37, "Auto TimeZone Setting Enabled & TimeZone Applied !!"
    ...
    .line 1311
    const-string v37, "zone : null, TimeZone(NeedFixZone) NOT Saved"
...
.method private regCodeToServiceState2(I)I
    .locals 1
    .param p1, "code"    # I
...
.method private revertToNitzTime()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->logt(Ljava/lang/String;)V
...
.method private setAndBroadcastNetworkSetTime(J)V
    ...
    sput-boolean v1, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->broadcast_check_time:Z
...
.method private setAndBroadcastNetworkSetTimeZone(Ljava/lang/String;)V
    ...
    sput-boolean v2, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->broadcast_check_time_zone:Z
...
.method private setTimeFromNITZString(Ljava/lang/String;J)V
    ...
    .line 1786
    const-string v25, "EVENT_NITZ_TIME received !!"
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->TimeZoneFix(ILjava/lang/String;)Ljava/util/TimeZone;
    ...
    .line 1879
    :cond_2
    const-string v25, "ZONE : null, NeedFixZone Enabled !!"
    ...
    const-string v26, "TimeZone(NITZ) Saved : "
    ...
    .line 1895
    const-string v25, "Auto TimeZone Setting Enabled & TimeZone Applied !!"
    ...
    .line 1904
    :cond_d
    const-string v25, "zone : null, TimeZone(NITZ) NOT Saved"
    ...
    .line 1918
    const-string v25, "UTC Time(NITZ) Saved"
    ...
    .line 1959
    const-string v25, "VITAMIN_TIME"

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string v27, "[TIME_SET] SKIP timeset!! gained(ms) : "
    ...
    .line 1971
    const-string v25, "Auto UTC Setting Enabled & UTC Applied !!"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/gsm/GSMPhone;->getMccInteger()I
    ...
    const-string v19, "[TIME_SET] EVENT_CHECK_MCC_AFTER_NITZ received !!(EVENT_NITZ_TIME + 1sec)"
    ...
    const-string v20, "[TIME_SET] current MCC : "
    ...
    const-string v20, ", time info stored MCC : "
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSavedMccInteger()I
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/gsm/GSMPhone;->getSavedMccInteger()I
    ...
    const-string v19, "[TIME_SET] NITZ_TIME_INFO intent is needed !!"
    ...
    const-string v19, "[TIME_SET] send INTENT : NITZ_TIME_INFO"
    ...
    const-string v18, "android.internal.telephony.sky.intent.action.NITZ_TIME_INFO"
    ...
    const-string v20, "[TIME_SET] Time info stored (from NITZ), MCC : "
    ...
    invoke-virtual {v0, v10}, Lcom/android/internal/telephony/gsm/GSMPhone;->saveCurrentMcc(I)V
    ...
    const-string v19, "[TIME_SET] NITZ_TIME_INFO intent is NOT needed !!"
...
.method protected handlePollStateResult(ILandroid/os/AsyncResult;)V
    ...
    invoke-direct {v0, v14, v1}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->isRoamingCompensation(ZLandroid/telephony/ServiceState;)Z
    ...
    const-string v19, "fake_roaming_mode_setting"
    ...
    const-string v20, "Limited - regState: "
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/gsm/GsmServiceStateTracker;->regCodeToServiceState2(I)I

    move-result v19

    invoke-virtual/range {v18 .. v19}, Landroid/telephony/ServiceState;->setSubState(I)V
    :try_end_2
    .catch Ljava/lang/RuntimeException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-virtual/range {v18 .. v19}, Landroid/telephony/ServiceState;->setRilDataRadioTechnology(I)V
    ...
    const-string v20, "450"

    const-string v21, "310"
    ...
    const-string v19, "RoamingTest_L"
    ...
    const-string v19, "RoamingTest_S"
    ...
    const-string v19, "network_selection_mode"
    ...
    .line 908
    .local v17, "userSelNetMode":Ljava/lang/String;
    const/16 v18, 0x0
    ...
    .line 884
    .end local v17    # "userSelNetMode":Ljava/lang/String;
    :cond_18
    const/16 v18, 0x0
    ...
    .line 914
    .restart local v17    # "userSelNetMode":Ljava/lang/String;
    :cond_19
    if-eqz v17, :cond_1a
