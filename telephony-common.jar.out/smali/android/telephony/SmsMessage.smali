...
.method public static getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Landroid/telephony/SmsMessage$SubmitPdu;
    .locals 8
    ...
    .line 446
    invoke-static/range {v0 .. v5}, Lcom/android/internal/telephony/gsm/SmsMessage;->getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J[B)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;

    move-result-object v7

    .line 455
    :goto_0
    new-instance v5, Landroid/telephony/SmsMessage$SubmitPdu;

    invoke-direct {v5, v7}, Landroid/telephony/SmsMessage$SubmitPdu;-><init>(Lcom/android/internal/telephony/SmsMessageBase$SubmitPduBase;)V
...
.method public static getDeliveryPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)Landroid/telephony/SmsMessage$SubmitPdu;
    .locals 9
    .param p0, "scAddress"    # Ljava/lang/String;
    .param p1, "callbackAddress"    # Ljava/lang/String;
    .param p2, "originAddress"    # Ljava/lang/String;
    ...
    invoke-direct {v5, v8}, Landroid/telephony/SmsMessage$SubmitPdu;-><init>(Lcom/android/internal/telephony/SmsMessageBase$SubmitPduBase;)V
    ...
    .line 481
    .local v7, "smsHdrInfo":Lcom/android/internal/telephony/SmsHeader;
    iput-object p1, v7, Lcom/android/internal/telephony/SmsHeader;->ReplyAddr:Ljava/lang/String;
    ...
    .end local v7    # "smsHdrInfo":Lcom/android/internal/telephony/SmsHeader;
    :cond_2
    invoke-static {p1}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    .line 497
    .restart local v7    # "smsHdrInfo":Lcom/android/internal/telephony/SmsHeader;
    iput-object p1, v7, Lcom/android/internal/telephony/SmsHeader;->ReplyAddr:Ljava/lang/String;
...
.method public static getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI[B)Landroid/telephony/SmsMessage$SubmitPdu;
    .locals 3
    .param p0, "scAddress"    # Ljava/lang/String;
    .param p1, "destinationAddress"    # Ljava/lang/String;
    .param p2, "message"    # Ljava/lang/String;
    ...
    :cond_0
    invoke-static/range {p0 .. p5}, Lcom/android/internal/telephony/gsm/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI[B)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
...
.method public static getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)Landroid/telephony/SmsMessage$SubmitPdu;
    ...
    .line 523
    invoke-static {p0, p1, p2, p3, p4}, Lcom/android/internal/telephony/gsm/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)Lcom/android/internal/telephony/gsm/SmsMessage$SubmitPdu;
...
.method public getTeleService()I
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/SmsMessageBase;->getTeleService()I
