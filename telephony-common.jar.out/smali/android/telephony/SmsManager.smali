...
.method public sendMessageWithUdh(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;[BI)V
    .locals 7
    ...
    invoke-static/range {v0 .. v5}, Landroid/telephony/SmsMessage;->getSubmitPdu(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZI[B)Landroid/telephony/SmsMessage$SubmitPdu;

    move-result-object v6

    .line 209
    .local v6, "pdu":Landroid/telephony/SmsMessage$SubmitPdu;
    :try_start_0
    const-string v1, "isms"
    ...
    iget-object v2, v6, Landroid/telephony/SmsMessage$SubmitPdu;->encodedScAddress:[B

    iget-object v3, v6, Landroid/telephony/SmsMessage$SubmitPdu;->encodedMessage:[B

    move-object v4, p4

    move-object v5, p5

    invoke-interface/range {v0 .. v5}, Lcom/android/internal/telephony/ISms;->sendRawMessageWithUdh(Ljava/lang/String;[B[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 206
    .end local v6    # "pdu":Landroid/telephony/SmsMessage$SubmitPdu;
    :cond_1
    const/4 v3, 0x0
    ...
    .line 214
    .restart local v6    # "pdu":Landroid/telephony/SmsMessage$SubmitPdu;
    :catch_0
    move-exception v1
...
.method public sendTextMessage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;I)V
    ...
    const-string v2, "destinationAddress is the same self-number"
    ...
    invoke-interface/range {v0 .. v8}, Lcom/android/internal/telephony/ISms;->sendTextWithCount(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
